...
public class ClosedLoop : MeasurementScript
{
    ...
    public void OnUpdateOutputSimpleAlgorithm()
    {
        ...
        {
            SingleTrack_DriverAssistanceCANoe.Parameters.DYNA4_Signal_Sources.DYNA4ExternalFunctionOutputs.Active.Value_.Value = 1;

            // Send the values to the DYNA4 scenario -> Closed Loop
            SingleTrack_DriverAssistanceCANoe.Parameters.DYNA4_Signal_Sources.DYNA4ExternalFunctionOutputs.BrakePedalPos.Value_.Value = 1;  // Full Brake
            SingleTrack_DriverAssistanceCANoe.Parameters.DYNA4_Signal_Sources.DYNA4ExternalFunctionOutputs.AccPedalPos.Value_.Value = 0;    // No Throttle
        }
        else // Not Active
        {
            SingleTrack_DriverAssistanceCANoe.Parameters.DYNA4_Signal_Sources.DYNA4ExternalFunctionOutputs.Active.Value_.Value = 0;
        }
    }
}