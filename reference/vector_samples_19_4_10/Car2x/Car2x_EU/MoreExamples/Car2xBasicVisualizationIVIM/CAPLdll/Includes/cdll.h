...
enum CAPL_DLL_CALLCONV {
  ...
  CAPL_DLL_CAN_MSG_VER_6 = 0x000C,// Binary 0000 0000 0000 1100, used for CANFD
  CAPL_DLL_CAN_MSG_VER_7 = 0x000E, // Binary 0000 0000 0000 1110, used for CANXL
  CAPL_DLL_CAN_MSG_VER_8 = 0x0010, // Binary 0000 0000 0001 0000, used for CANXL with new bit timing struct
};
...
#define CAPL_FUNCTION_FLAG_ENCODING_IRRELEVANT 8
#define CAPL_FUNCTION_FLAG_ENCODING_AWARE 16
