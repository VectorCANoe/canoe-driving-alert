...
#pragma region global Variables
  ...
  VApplication* gApplication = nullptr;
  ...
  VGetModuleOptions_InterfaceTypeOptions gInterfaceType = kVIA_ModuleOption_InterfaceType_Default;
...
#pragma endregion
  ...
  bool isInterfaceTypeDefault() {
    return gInterfaceType == kVIA_ModuleOption_InterfaceType_Default;
  }
...
#pragma region FunctionBus API and Utilities
  ...
  namespace NDetail
  {
    ...
    // RemovePrefix returns the substring of the given string literal by skipping the first character
    inline const char* RemovePrefix(const char* literal)
    {
      if (literal == nullptr || *literal == char(0))
      {
        return literal;
      }
      else
    ...
    void ExtractValueClass(std::string& remaining, VIAFbValueClass& valueClass)
    {
      ...
      {
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_SERVICE_STATE), VIAFbValueClass::eServiceState, nullptr));
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_CONNECTION_STATE), VIAFbValueClass::eConnectionState, nullptr));
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_SUBSCRIPTION_STATE), VIAFbValueClass::eSubscriptionState, nullptr));
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_LATEST_CALL), VIAFbValueClass::eLatestCall, nullptr));
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_LATEST_RETURN CCL_MEMBER_RESULT), VIAFbValueClass::eLatestReturn, "ReturnValue")); // keep before LATEST_RETURN
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_LATEST_RETURN), VIAFbValueClass::eLatestReturn, nullptr));
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_PARAM_DEFAULTS), VIAFbValueClass::eParamDefaults, nullptr));
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_DEFAULT_RESULT), VIAFbValueClass::eParamDefaults, "ReturnValue"));
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_AUTO_ANSWER_MODE), VIAFbValueClass::eParamDefaults, "ServerSimulatorMode"));
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_AUTO_ANSWER_TIME), VIAFbValueClass::eParamDefaults, "ReturnDelay"));
        sMemberKeywords.push_back(MemberKeyword<VIAFbValueClass>(RemovePrefix(CCL_MEMBER_ANNOUNCEMENT_STATE), VIAFbValueClass::eAnnouncementState, nullptr));
      }
    ...
    void ExtractValueClass(std::string& remaining, CallContextValueClass& valueClass)
    {
      ...
      if (sMemberKeywords.empty())
      {
        sMemberKeywords.push_back(MemberKeyword<CallContextValueClass>(RemovePrefix(CCL_MEMBER_IN_PARAM), CallContextValueClass::eInParam, nullptr));
        sMemberKeywords.push_back(MemberKeyword<CallContextValueClass>(RemovePrefix(CCL_MEMBER_OUT_PARAM), CallContextValueClass::eOutParam, nullptr));
        sMemberKeywords.push_back(MemberKeyword<CallContextValueClass>(RemovePrefix(CCL_MEMBER_RESULT), CallContextValueClass::eResultValue, "ReturnValue"));
        sMemberKeywords.push_back(MemberKeyword<CallContextValueClass>(RemovePrefix(CCL_MEMBER_CALL_TIME), CallContextValueClass::eCallTime, nullptr));
        sMemberKeywords.push_back(MemberKeyword<CallContextValueClass>(RemovePrefix(CCL_MEMBER_RETURN_TIME), CallContextValueClass::eReturnTime, nullptr));
        sMemberKeywords.push_back(MemberKeyword<CallContextValueClass>(RemovePrefix(CCL_MEMBER_CALL_STATE), CallContextValueClass::eCallState, nullptr));
        sMemberKeywords.push_back(MemberKeyword<CallContextValueClass>(RemovePrefix(CCL_MEMBER_REQUEST_ID), CallContextValueClass::eRequestID, nullptr));
        sMemberKeywords.push_back(MemberKeyword<CallContextValueClass>(RemovePrefix(CCL_MEMBER_SIDE), CallContextValueClass::eSide, nullptr));
        sMemberKeywords.push_back(MemberKeyword<CallContextValueClass>(RemovePrefix(CCL_MEMBER_CONSUMER_PORT), CallContextValueClass::eConsumerPort, nullptr));
        sMemberKeywords.push_back(MemberKeyword<CallContextValueClass>(RemovePrefix(CCL_MEMBER_PROVIDER_PORT), CallContextValueClass::eProviderPort, nullptr));
      }
...
#pragma endregion
  ...
  struct IValue
  {
    ...
    virtual int32_t BeginBulkUpdate() = 0;
    virtual int32_t EndBulkUpdate() = 0;
  ...
  public:
    ...
    virtual int32_t BeginBulkUpdate() { return CCL_INVALIDDOMAIN; }
    virtual int32_t EndBulkUpdate() { return CCL_INVALIDDOMAIN; }
  ...
  public:
    ...
    virtual int32_t BeginBulkUpdate();
    virtual int32_t EndBulkUpdate();
  ...
  {
  public:
    VModuleContext();  // Default constructor
    ~VModuleContext() {};

    // Delete copy constructor and copy assignment operator
    VModuleContext(const VModuleContext&) = delete;
    VModuleContext& operator=(const VModuleContext&) = delete;

    // Delete move constructor and move assignment operator
    VModuleContext(VModuleContext&&) = delete;
    VModuleContext& operator=(VModuleContext&&) = delete;
    ...
    // Overloaded releaseItem declarations
    void ReleaseMTimer();
    void ReleaseMSysVar();
    void ReleaseMSignal();
    void ReleaseMServices();
  ...
  public:
    ...
    VIASTDDECL PreStartMeasurement();
  public:
  ...
  class VApplication : public VIAApplication
  {
  public:
    VApplication();
...
#pragma region VSysVar Implementation
  ...
  {
    if (!gModuleContext.IsModuleInitialized())
    {
      return CCL_INTERNALERROR;
    }

    if (sysVarID < 0 || sysVarID >= static_cast<int32_t>(gModuleContext.mSysVar.size()))
    {
      return CCL_INVALIDSYSVARID;
    }

    sysVar = gModuleContext.mSysVar[sysVarID];
...
#pragma region VSignal Implementation
  ...
  int32_t VSignal::LookupSignal(int32_t signalID, VSignal*& signal)
  {
    ...
    if (signalID < 0 || signalID >= static_cast<int32_t>(gModuleContext.mSignal.size()))
    {
      return CCL_INVALIDSIGNALID;
    }

    signal = gModuleContext.mSignal[signalID];
...
#pragma region VValueBase Implementation
  ...
  int32_t IValue::LookupValue(cclValueID valueID, T*& value)
  {
    ...
    value = dynamic_cast<T*>(gModuleContext.mValues.Get(valueID));
    if (value == nullptr)
    ...
    if (fbAPI->GetValuePort(portPath, &port) != kVIA_OK)
    {
      ...
      if (lastPoint != nullptr)
      {
        ...
        if (fbAPI->GetValuePort(possiblePduPath.c_str(), &port) == kVIA_OK)
        {
          ...
          return gModuleContext.mValues.Add(valueEntity.release());
        }
      }
...
#pragma region VDOValueEntity Implementation
  ...
  int32_t VDOValueEntity::BeginBulkUpdate()
  {
    if (mMember == nullptr)
      return CCL_INTERNALERROR;
    ...
    case ePortValue:
    {
      ...
      auto ret = VIAQueryFbDOMemberInterface(mMember, &pDOValueProvider);
      if (ret != kVIA_OK) return ret;
      ret = pDOValueProvider->BeginValueBulkUpdate();
      pDOValueProvider->Release();
      return ret == kVIA_OK ? CCL_SUCCESS : CCL_VALUEREADONLY;
    }
    default:
  ...
  int32_t VDOValueEntity::EndBulkUpdate()
  {
    if (mMember == nullptr)
      return CCL_INTERNALERROR;
    ...
    case ePortValue:
    {
      ...
      auto ret = VIAQueryFbDOMemberInterface(mMember, &pDOValueProvider);
      if (ret != kVIA_OK) return ret;
      ret = pDOValueProvider->EndValueBulkUpdate();
      pDOValueProvider->Release();
      return ret == kVIA_OK ? CCL_SUCCESS : CCL_VALUEREADONLY;
    }
    default:
...
#pragma region VCallContextValue Implementation
  ...
  int32_t VCallContextValue::CreateCallContextValue(cclCallContextID ctxtID, const char* memberPath, cclValueRepresentation repr)
  {
    ...
    return gModuleContext.mValues.Add(callContextValue.release());
  }
  ...
  VIAFbCallContext* VCallContextValue::GetCallContext() const
  {
    ...
    VCallContext* callContext = gModuleContext.mCallContexts.Get(mCallContextID);
...
#pragma region VPDUSignalValue Implementation
  ...
  int32_t VPDUSignalValue<PortType>::CreateSignalValue(PortType* port, const char* signalName, const char* member, cclValueRepresentation repr)
  {
    ...
    return gModuleContext.mValues.Add(signalValue.release());
  }
...
#pragma region VFunction Implementation
  ...
  namespace VFunctionUtils
  {
    int32_t LookupFunction(cclFunctionID functionID, IFunctionPort*& function)
    {
      ...
      function = gModuleContext.mFunctions.Get(functionID);
      if (function == nullptr)
    ...
    cclCallContextID CreateCallContext(VIAFbCallContext* ctxt, cclFunctionID funcID, bool release)
    {
      ...
      return gModuleContext.mCallContexts.Add(new VCallContext(funcID, ctxt, release));
    }
    ...
    bool DestroyCallContext(cclCallContextID ctxtID)
    {
      ...
      return gModuleContext.mCallContexts.Remove(ctxtID);
    }
  }
  ...
  int32_t VClientFunction::CreateClientFunction(const char* portPath)
  {
    ...
    return gModuleContext.mFunctions.Add(fct);
  }
    ...
    VIAFbFunctionCallState inCallState)
  {
    ...
    if (this->mCallbacks[callbackIndex].mCallbackFunction != nullptr)
    {
      ...
      else
      {
        ...
        if (ret != kVIA_OK) return ret;
        auto existingCC = gModuleContext.mCallContexts.Get(ctxtID);
        if (!existingCC)
        {
          useNewCallContext = true;
        }
  ...
  int32_t DOMethods::CreateDOMethod(const char* doMemberPath)
  {
    ...
    case eFbDOMemberDirection_Internal:
    {
      ...
      return gModuleContext.mFunctions.Add(method);
    }
  ...
  VCallContext::~VCallContext()
  {
    ...
    {
      gModuleContext.mValues.Remove(valueID);
    }
  }
...
#pragma region VService Implementation
  ...
  int32_t VService::CreateService(const char* path)
  {
    ...
    cclServiceID serviceID = static_cast<cclServiceID>(gModuleContext.mServices.size());
    ...
    gModuleContext.mServices.push_back(service.release());
  ...
  int32_t VService::LookupService(cclServiceID serviceID, VService*& service)
  {
    ...
    if (serviceID < 0 || serviceID >= static_cast<int32_t>(gModuleContext.mServices.size()))
      return CCL_INVALIDSERVICEID;

    service = gModuleContext.mServices[serviceID];
  ...
  {
    gModuleContext.ReleaseMServices();
  }
...
#pragma region VConsumer Implementation
  ...
  int32_t VConsumer::CreateConsumer(const char* path)
  {
    ...
    return gModuleContext.mConsumers.Add(new VConsumer(consumer, true));
  }
  ...
  int32_t VConsumer::CreateConsumer(VIAFbServiceConsumer* consumer, bool release)
  {
    ...
    return gModuleContext.mConsumers.Add(new VConsumer(consumer, release));
  }
  ...
  int32_t VConsumer::LookupConsumer(cclConsumerID consumerID, VConsumer*& consumer)
  {
    ...
    consumer = gModuleContext.mConsumers.Get(consumerID);
    if (consumer == nullptr)
  ...
  int32_t VConsumer::RemoveConsumer(cclConsumerID consumerID)
  {
    ...
    VConsumer* consumer = gModuleContext.mConsumers.Get(consumerID);
    if (consumer == nullptr)
      return CCL_INVALIDCONSUMERID;

    return gModuleContext.mConsumers.Remove(consumerID) ? CCL_SUCCESS : CCL_INTERNALERROR;
  }
...
#pragma region VProvider Implementation
  ...
  int32_t VProvider::CreateProvider(const char* path)
  {
    ...
    return gModuleContext.mProviders.Add(new VProvider(provider, true));
  }
  ...
  int32_t VProvider::CreateProvider(VIAFbServiceProvider* provider, bool release)
  {
    ...
    return gModuleContext.mProviders.Add(new VProvider(provider, release));
  }
  ...
  int32_t VProvider::LookupProvider(cclProviderID providerID, VProvider*& provider)
  {
    ...
    provider = gModuleContext.mProviders.Get(providerID);
    if (provider == nullptr)
  ...
  int32_t VProvider::RemoveProvider(cclProviderID providerID)
  {
    ...
    VProvider* provider = gModuleContext.mProviders.Get(providerID);
    if (provider == nullptr)
      return CCL_INVALIDPROVIDERID;

    return gModuleContext.mProviders.Remove(providerID) ? CCL_SUCCESS : CCL_INTERNALERROR;
  }
...
#pragma region VConsumedService Implementation
  ...
  int32_t VConsumedService::CreateConsumedService(const char* path)
  {
    ...
    return gModuleContext.mConsumedServices.Add(new VConsumedService(consumedService));
  }
  ...
  int32_t VConsumedService::LookupConsumedService(cclConsumedServiceID consumedServiceID, VConsumedService*& consumedService)
  {
    ...
    consumedService = gModuleContext.mConsumedServices.Get(consumedServiceID);
...
#pragma region VProvidedService Implementation
  ...
  int32_t VProvidedService::CreateProvidedService(const char* path)
  {
    ...
    return gModuleContext.mProvidedServices.Add(new VProvidedService(providedService));
  }
  ...
  int32_t VProvidedService::LookupProvidedService(cclProvidedServiceID providedServiceID, VProvidedService*& providedService)
  {
    ...
    providedService = gModuleContext.mProvidedServices.Get(providedServiceID);
...
#pragma region VAddress Implementation
  ...
  cclAddressID VAddress::CreateAddress(VIAFbAddressHandle* address, bool release)
  {
    ...
    return gModuleContext.mAddresses.Add(new VAddress(address, release));
  }
  ...
  int32_t VAddress::LookupAddress(cclAddressID addressID, VAddress*& address)
  {
    ...
    address = gModuleContext.mAddresses.Get(addressID);
    if (address == nullptr)
  ...
  int32_t VAddress::RemoveAddress(cclAddressID addressID)
  {
    ...
    VAddress* address = gModuleContext.mAddresses.Get(addressID);
    if (address == nullptr)
      return CCL_INVALIDADDRESSID;

    return gModuleContext.mAddresses.Remove(addressID) ? CCL_SUCCESS : CCL_INTERNALERROR;
  }
...
#pragma region VPDUSender Implementation
  ...
  int32_t VPDUSender::CreatePDUSender(const char* path)
  {
    ...
    return gModuleContext.mPDUSender.Add(new VPDUSender(pduSender, true));
  }
  ...
  int32_t VPDUSender::LookupPDUSender(cclPDUSenderID pduSenderID, VPDUSender*& pduSender)
  {
    ...
    pduSender = gModuleContext.mPDUSender.Get(pduSenderID);
...
#pragma region VPDUReceiver Implementation
  ...
  int32_t VPDUReceiver::CreatePDUReceiver(const char* path)
  {
    ...
    return gModuleContext.mPDUReceiver.Add(new VPDUReceiver(pduReceiver));
  }
  ...
  int32_t VPDUReceiver::LookupPDUReceiver(cclPDUReceiverID pduReceiverID, VPDUReceiver*& pduReceiver)
  {
    ...
    pduReceiver = gModuleContext.mPDUReceiver.Get(pduReceiverID);
...
#pragma region VConsumedServicePDU Implementation
  ...
  int32_t VConsumedServicePDU::CreateConsumedPDU(const char* path)
  {
    ...
    return gModuleContext.mPDUReceiver.Add(new VConsumedServicePDU(consumedPDU));
  }
  ...
  int32_t VConsumedServicePDU::LookupConsumedPDU(cclPDUReceiverID consumedPDUID, VConsumedServicePDU*& consumedPDU)
  {
    ...
    auto* pduReceiver = gModuleContext.mPDUReceiver.Get(consumedPDUID);
    if (pduReceiver == nullptr)
  ...
  int32_t VAbstractConsumedServicePDU::CreateConsumedPDU(const char* path)
  {
    ...
    return gModuleContext.mPDUReceiver.Add(new VAbstractConsumedServicePDU(consumedPDU));
  }
  ...
  int32_t VAbstractConsumedServicePDU::LookupConsumedPDU(cclPDUReceiverID consumedPDUID, VAbstractConsumedServicePDU*& consumedPDU)
  {
    ...
    VPDUReceiver* pduReceiver = gModuleContext.mPDUReceiver.Get(consumedPDUID);
    if (pduReceiver == nullptr)
      return CCL_INVALIDCONSUMEDPDUID;
...
#pragma region VProvidedServicePDU Implementation
  ...
  int32_t VProvidedServicePDU::CreateProvidedPDU(const char* path)
  {
    ...
    return gModuleContext.mPDUSender.Add(new VProvidedServicePDU(providedPDU, true));
  }
  ...
  int32_t VProvidedServicePDU::CreateProvidedPDU(VIAFbProvidedServicePDU* providedPDU, bool release)
  {
    ...
    return gModuleContext.mPDUSender.Add(new VProvidedServicePDU(providedPDU, release));
  }
  ...
  int32_t VProvidedServicePDU::LookupProvidedPDU(cclPDUSenderID providedPDUID, VProvidedServicePDU*& providedPDU)
  {
    ...
    auto* pduSender = gModuleContext.mPDUSender.Get(providedPDUID);
    if (pduSender == nullptr)
  ...
  int32_t VProvidedServicePDU::RemoveProvidedPDU(cclPDUSenderID providedPDUID)
  {
    ...
    VPDUSender* providedPDU = gModuleContext.mPDUSender.Get(providedPDUID);
    if (providedPDU == nullptr)
      return CCL_INVALIDPROVIDEDPDUID;

    return gModuleContext.mPDUSender.Remove(providedPDUID) ? CCL_SUCCESS : CCL_INTERNALERROR;
  }
...
#pragma region VServicePDUProvider Implementation
  ...
  int32_t VServicePDUProvider::CreatePDUProvider(const char* path)
  {
    ...
    return gModuleContext.mPDUProviders.Add(new VServicePDUProvider(pduProvider));
  }
  ...
  int32_t VServicePDUProvider::LookupPDUProvider(cclPDUProviderID pduProviderID, VServicePDUProvider*& pduProvider)
  {
    ...
    pduProvider = gModuleContext.mPDUProviders.Get(pduProviderID);
  ...
  int32_t VAbstractServicePDUProvider::CreatePDUProvider(const char* path)
  {
    ...
    return gModuleContext.mPDUProviders.Add(new VAbstractServicePDUProvider(pduProvider));
  }
  ...
  int32_t VAbstractServicePDUProvider::LookupPDUProvider(cclPDUProviderID pduProviderID, VAbstractServicePDUProvider*& pduProvider)
  {
    ...
    VServicePDUProvider* baseProvider = gModuleContext.mPDUProviders.Get(pduProviderID);
...
#pragma region VConsumedEvent Implementation
  ...
  int32_t VConsumedEvent::CreateConsumedEvent(const char* path)
  {
    ...
    return gModuleContext.mConsumedEvents.Add(new VConsumedEvent(consumedEvent));
  }
  ...
  int32_t VConsumedEvent::LookupConsumedEvent(cclConsumedEventID consumedEventID, VConsumedEvent*& consumedEvent)
  {
    ...
    consumedEvent = gModuleContext.mConsumedEvents.Get(consumedEventID);
  ...
  int32_t VAbstractConsumedEvent::CreateConsumedEvent(const char* path)
  {
    ...
    return gModuleContext.mConsumedEvents.Add(new VAbstractConsumedEvent(consumedEvent));
  }
  ...
  int32_t VAbstractConsumedEvent::LookupConsumedEvent(cclConsumedEventID consumedEventID, VAbstractConsumedEvent*& consumedEvent)
  {
    ...
    VConsumedEvent* baseEvent = gModuleContext.mConsumedEvents.Get(consumedEventID);
...
#pragma region VProvidedEvent Implementation
  ...
  int32_t VProvidedEvent::CreateProvidedEvent(const char* path)
  {
    ...
    return gModuleContext.mProvidedEvents.Add(new VProvidedEvent(providedEvent, true));
  }
  ...
  int32_t VProvidedEvent::CreateProvidedEvent(VIAFbProvidedEvent* providedEvent, bool release)
  {
    ...
    return gModuleContext.mProvidedEvents.Add(new VProvidedEvent(providedEvent, release));
  }
  ...
  int32_t VProvidedEvent::LookupProvidedEvent(cclProvidedEventID providedEventID, VProvidedEvent*& providedEvent)
  {
    ...
    providedEvent = gModuleContext.mProvidedEvents.Get(providedEventID);
  ...
  int32_t VProvidedEvent::RemoveProvidedEvent(cclProvidedEventID providedEventID)
  {
    ...
    VProvidedEvent* providedEvent = gModuleContext.mProvidedEvents.Get(providedEventID);
    if (providedEvent == nullptr)
      return CCL_INVALIDPROVIDEDEVENTID;

    return gModuleContext.mProvidedEvents.Remove(providedEventID) ? CCL_SUCCESS : CCL_INTERNALERROR;
  }
...
#pragma region VEventProvider Implementation
  ...
  int32_t VEventProvider::CreateEventProvider(const char* path)
  {
    ...
    return gModuleContext.mEventProviders.Add(new VEventProvider(eventProvider));
  }
  ...
  int32_t VEventProvider::LookupEventProvider(cclEventProviderID eventProviderID, VEventProvider*& eventProvider)
  {
    ...
    eventProvider = gModuleContext.mEventProviders.Get(eventProviderID);
  ...
  int32_t VAbstractEventProvider::CreateEventProvider(const char* path)
  {
    ...
    return gModuleContext.mEventProviders.Add(new VAbstractEventProvider(eventProvider));
  }
  ...
  int32_t VAbstractEventProvider::LookupEventProvider(cclEventProviderID eventProviderID, VAbstractEventProvider*& eventProvider)
  {
    ...
    VEventProvider* baseProvider = gModuleContext.mEventProviders.Get(eventProviderID);
    if (baseProvider == nullptr)
      return CCL_INVALIDEVENTPROVIDERID;
...
#pragma region VConsumedField Implementation
  ...
  int32_t VConsumedField::CreateConsumedField(const char* path)
  {
    ...
    return gModuleContext.mConsumedFields.Add(new VConsumedField(consumedField));
  }
  ...
  int32_t VConsumedField::LookupConsumedField(cclConsumedFieldID consumedFieldID, VConsumedField*& consumedField)
  {
    ...
    consumedField = gModuleContext.mConsumedFields.Get(consumedFieldID);
  ...
  int32_t VAbstractConsumedField::CreateConsumedField(const char* path)
  {
    ...
    return gModuleContext.mConsumedFields.Add(new VAbstractConsumedField(consumedField));
  }
  ...
  int32_t VAbstractConsumedField::LookupConsumedField(cclConsumedFieldID consumedFieldID, VAbstractConsumedField*& consumedField)
  {
    ...
    VConsumedField* baseField = gModuleContext.mConsumedFields.Get(consumedFieldID);
...
#pragma region VProvidedField Implementation
  ...
  int32_t VProvidedField::CreateProvidedField(const char* path)
  {
    ...
    return gModuleContext.mProvidedFields.Add(new VProvidedField(providedField, true));
  }
  ...
  int32_t VProvidedField::CreateProvidedField(VIAFbProvidedField* providedField, bool release)
  {
    ...
    return gModuleContext.mProvidedFields.Add(new VProvidedField(providedField, release));
  }
  ...
  int32_t VProvidedField::LookupProvidedField(cclProvidedFieldID providedFieldID, VProvidedField*& providedField)
  {
    ...
    providedField = gModuleContext.mProvidedFields.Get(providedFieldID);
  ...
  int32_t VProvidedField::RemoveProvidedField(cclProvidedFieldID providedFieldID)
  {
    ...
    VProvidedField* providedField = gModuleContext.mProvidedFields.Get(providedFieldID);
    if (providedField == nullptr)
      return CCL_INVALIDPROVIDEDFIELDID;

    return gModuleContext.mProvidedFields.Remove(providedFieldID) ? CCL_SUCCESS : CCL_INTERNALERROR;
  }
...
#pragma region VFieldProvider Implementation
  ...
  int32_t VFieldProvider::CreateFieldProvider(const char* path)
  {
    ...
    return gModuleContext.mFieldProviders.Add(new VFieldProvider(fieldProvider));
  }
  ...
  int32_t VFieldProvider::LookupFieldProvider(cclFieldProviderID fieldProviderID, VFieldProvider*& fieldProvider)
  {
    ...
    fieldProvider = gModuleContext.mFieldProviders.Get(fieldProviderID);
  ...
  int32_t VAbstractFieldProvider::CreateFieldProvider(const char* path)
  {
    ...
    return gModuleContext.mFieldProviders.Add(new VAbstractFieldProvider(fieldProvider));
  }
  ...
  int32_t VAbstractFieldProvider::LookupFieldProvider(cclFieldProviderID fieldProviderID, VAbstractFieldProvider*& fieldProvider)
  {
    ...
    VFieldProvider* baseProvider = gModuleContext.mFieldProviders.Get(fieldProviderID);
    if (baseProvider == nullptr)
      return CCL_INVALIDFIELDPROVIDERID;
...
#pragma region VConsumedEventGroup Implementation
  ...
  int32_t VConsumedEventGroup::CreateConsumedEventGroup(const char* path)
  {
    ...
    return gModuleContext.mConsumedEventGroups.Add(new VConsumedEventGroup(consumedEventGroup));
  }
  ...
  int32_t VConsumedEventGroup::LookupConsumedEventGroup(cclSomeIPConsumedEventGroupID consumedEventGroupID, VConsumedEventGroup*& consumedEventGroup)
  {
    ...
    consumedEventGroup = gModuleContext.mConsumedEventGroups.Get(consumedEventGroupID);
...
#pragma region VProvidedEventGroup Implementation
  ...
  int32_t VProvidedEventGroup::CreateProvidedEventGroup(const char* path)
  {
    ...
    return gModuleContext.mProvidedEventGroups.Add(new VProvidedEventGroup(providedEventGroup, true));
  }
  ...
  int32_t VProvidedEventGroup::CreateProvidedEventGroup(VIAFbSomeIPProvidedEventGroup* providedEventGroup)
  {
    ...
    return gModuleContext.mProvidedEventGroups.Add(new VProvidedEventGroup(providedEventGroup, false));
  }
  ...
  int32_t VProvidedEventGroup::LookupProvidedEventGroup(cclSomeIPProvidedEventGroupID providedEventGroupID, VProvidedEventGroup*& providedEventGroup)
  {
    ...
    providedEventGroup = gModuleContext.mProvidedEventGroups.Get(providedEventGroupID);
  ...
  int32_t VProvidedEventGroup::RemoveProvidedEventGroup(cclSomeIPProvidedEventGroupID providedEventGroupID)
  {
    ...
    VProvidedEventGroup* providedEventGroup = gModuleContext.mProvidedEventGroups.Get(providedEventGroupID);
    if (providedEventGroup == nullptr)
      return CCL_INVALIDPROVIDEDEVENTGROUPID;

    return gModuleContext.mProvidedEventGroups.Remove(providedEventGroupID) ? CCL_SUCCESS : CCL_INTERNALERROR;
  }
...
#pragma region VEventGroupProvider Implementation
  ...
  int32_t VEventGroupProvider::CreateEventGroupProvider(const char* path)
  {
    ...
    return gModuleContext.mEventGroupProviders.Add(new VEventGroupProvider(eventGroupProvider));
  }
  ...
  int32_t VEventGroupProvider::LookupEventGroupProvider(cclSomeIPEventGroupProviderID eventGroupProviderID, VEventGroupProvider*& eventGroupProvider)
  {
    ...
    eventGroupProvider = gModuleContext.mEventGroupProviders.Get(eventGroupProviderID);
...
#pragma region VNodeLayerModule Implementation
  ...
  VIASTDDEF VNodeLayerModule::GetVersion(char* buffer, int32 bufferLength)
  {
    ...
    {
      UtilStringCopy(buffer, bufferLength, "CANaylzer/CANoe C Library Version 2.1");
    }
    return kVIA_OK;
  }
  ...
  VIASTDDEF VNodeLayerModule::ReleaseObject(VIANodeLayerApi* object)
  {
    ...
    else if (busType == kVIA_Ethernet && channel >= 1 && channel <= cMaxChannel)
    {
      ...
      gEthernetBusContext[channel].mNode = nullptr;
      gEthernetBusContext[channel].mLayer = nullptr;
      gEthernetBusContext[channel].mBusName.clear();
    }
  ...
  VIASTDDEF VNodeLayerModule::EndMeasurement()
  {
    ...
    gModuleContext.ReleaseMTimer();
    gModuleContext.ReleaseMSysVar();
    ...
    gModuleContext.ReleaseMServices();
    gModuleContext.ClearObjectMaps();
...
#pragma region VNodeLayer Implementation
  ...
  VIASTDDEF  VNodeLayer::InitMeasurement()
  {
    if (gState == eLoaded)
    {
      ...
      if (gModuleContext.mMeasurementPreStartHandler != nullptr)
      {
        gModuleContext.mMeasurementPreStartHandler();
      }
    }
    return kVIA_OK;
  }
  ...
  VIASTDDEF  VNodeLayer::StartMeasurement()
  {
    if (gState == eInitMeasurement)
    {
      ...
      if (gModuleContext.mMeasurementStartHandler != nullptr)
      {
        gModuleContext.mMeasurementStartHandler();
      }
    }
    return kVIA_OK;
  }
  ...
  VIASTDDEF  VNodeLayer::StopMeasurement()
  {
    if (gState == eRunMeasurement)
    {
      ...
      if (gModuleContext.mMeasurementStopHandler != nullptr)
      {
        gModuleContext.mMeasurementStopHandler();
      }
    }
    return kVIA_OK;
  }
  ...
  VIASTDDEF VNodeLayer::PreStartMeasurement()
  {
    return kVIA_OK;
  }
#pragma endregion 
...
#pragma region VModuleContext Implementation
  // ============================================================================
  // Implementation of class VModuleContext
  // ============================================================================

  VModuleContext::VModuleContext() :
  ...
  void VModuleContext::ReleaseMTimer() {
    // delete Timers
    std::for_each(mTimer.begin(), mTimer.end(), [](VTimer* pTimer) {
      if (pTimer) {
        gVIAService->ReleaseTimer(pTimer->mViaTimer);
        pTimer->mViaTimer = nullptr;
        delete pTimer;
        pTimer = nullptr;
      }
    });
  ...
  void VModuleContext::ReleaseMSignal() {
    std::for_each(mSignal.begin(), mSignal.end(), [](VSignal* pSignal) {
      if (pSignal) {
        gSignalAccessAPI->ReleaseSignal(pSignal->mViaSignal);
        delete pSignal;
        pSignal = nullptr;
      }
    });
  ...
  void VModuleContext::ReleaseMSysVar() {
    std::for_each(mSysVar.begin(), mSysVar.end(), [](VSysVar* pSysVar) {
      if (pSysVar) {
        if (pSysVar->mViaSysVarMember)
        {
          std::ignore = pSysVar->mViaSysVarMember->Release();
          pSysVar->mViaSysVarMember = nullptr;
        }
        if (pSysVar->mViaSysVar != nullptr)
        {
          std::ignore = pSysVar->mViaSysVar->Release();
          pSysVar->mViaSysVar = nullptr;
        }
        delete pSysVar;
        pSysVar = nullptr;
      }
  ...
  void VModuleContext::ReleaseMServices() {
    std::for_each(mServices.begin(), mServices.end(), [](VService* pService) {
      if (pService) {
        delete pService;
        pService = nullptr;
      }
  ...
  void VModuleContext::ClearObjectMaps() {
    mValues.Clear();
    mFunctions.Clear();
    mCallContexts.Clear();
    mConsumers.Clear();
  ...
  bool VModuleContext::IsModuleInitialized() {
    // XOR Operator
    return ((gModule != nullptr) || (gApplication != nullptr));
  };
#pragma endregion

#pragma region VApplication Implementation
  ...
  VIASTDDEF VApplication::Init()
  {
    return kVIA_OK;
  }
  VIASTDDEF VApplication::GetVersion(char* buffer, int32 bufferLength)
  {
    if (buffer != nullptr && bufferLength > 0)
    {
      UtilStringCopy(buffer, bufferLength, "CANaylzer/CANoe C Library Version 2.1");
  ...
  VIASTDDEF  VApplication::InitMeasurement()
  {
    if (gState == eLoaded)
    {

      VIAResult rc = gVIAService->CreateSignalAccessApi(0, VIABusInterfaceType::kVIA_Wildcard, gSignalAccessAPI);
  ...
  VIASTDDEF  VApplication::StartMeasurement()
  {
    if (gState == eInitMeasurement)
    {
      gState = eRunMeasurement;
  ...
  VIASTDDEF  VApplication::StopMeasurement()
  {
    if (gState == eRunMeasurement)
    {
      gState = eStopMeasurement;
  ...
  VIASTDDEF VApplication::EndMeasurement()
  {
    gState = eLoaded;
    ...
    gModuleContext.ReleaseMServices();
    gModuleContext.ClearObjectMaps();
    std::ignore = (gVIAService->DestroySignalAccessApi(0, VIABusInterfaceType::kVIA_Wildcard));
    return kVIA_OK;
  }


  VIASTDDEF VApplication::InitMeasurementComplete()
  {
    return kVIA_OK;
  }


  VIASTDDEF VApplication::PreInitMeasurement()
  {
    return kVIA_OK;
  }

  VIASTDDEF VApplication::PreStopMeasurement()
  {
    return kVIA_OK;
  }
  VIASTDDEF VApplication::PreStartMeasurement()
  {
    return kVIA_OK;
  }
#pragma endregion
...
VIACLIENT(void) VIASetService(VIAService* service)
{
  ...
  if (isInterfaceTypeDefault()) {
    // ModuleApi is default for backward compatibility
    gInterfaceType = kVIA_ModuleOption_InterfaceType_ModuleApi;
  }
}
...
VIACLIENT(void) VIAReleaseModuleApi(VIAModuleApi* api)
{
  ...
  if (gModule != nullptr && gModuleContext.mDllUnloadHandler != nullptr)
  {
    gModuleContext.mDllUnloadHandler();
  }
...
VIACLIENT(void) VIAReleaseApplication(VIAApplication* api)
{
  gState = eUnloaded;

  if (gApplication != nullptr && gModuleContext.mDllUnloadHandler != nullptr)
  {
    gModuleContext.mDllUnloadHandler();
  }
...
#endif
{
  ...
  else if (option == kVIA_GetModuleOption_InterfaceType)
  {
...
void cclSetInterfaceType(cclInterfaceType ifType = CCL_MODULE_API) {
  switch (ifType) {
  case CCL_MODULE_API:
    gInterfaceType = kVIA_ModuleOption_InterfaceType_ModuleApi;
    break;

  case CCL_APPLICATION_MODEL:
    gInterfaceType = kVIA_ModuleOption_InterfaceType_ApplicationModel;
    break;
...
{
  gModuleContext.mMeasurementPreStartHandler = function;
}
...
{
  gModuleContext.mMeasurementStartHandler = function;
}
...
{
  gModuleContext.mMeasurementStopHandler = function;
}
...
{
  gModuleContext.mDllUnloadHandler = function;
}
...
int32_t cclTimerCreate(void (*function)(int64_t time, int32_t timerID))
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement)
    if (!gModuleContext.IsModuleInitialized() || gVIAService == nullptr)
    {
      return CCL_INTERNALERROR;
    }
  if (function == nullptr)
  ...
  VIANode* pNode = gModule ? gMasterLayer->mNode : nullptr; // Node is only assigned for Nodelayer

  VIAResult rc = gVIAService->CreateTimer(&viaTimer, pNode, cclTimer, "C-Library Timer");
  if (rc != kVIA_OK)
  {
    delete cclTimer;
    return CCL_INTERNALERROR;
  ...
  cclTimer->mTimerID = static_cast<int32_t>(gModuleContext.mTimer.size());
  gModuleContext.mTimer.push_back(cclTimer);
...
int32_t cclTimerSet(int32_t timerID, int64_t nanoseconds)
{
  ...
  if (timerID < 0 || timerID >= static_cast<int32_t>(gModuleContext.mTimer.size()))
  {
    return CCL_INVALIDTIMERID;
  }

  VTimer* cclTimer = gModuleContext.mTimer[timerID];
...
int32_t cclSysVarGetID(const char* systemVariableName)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement)
    if (gSysVarRoot == nullptr || !gModuleContext.IsModuleInitialized())
    {
      return CCL_INTERNALERROR;
    }
  ...
  cclSysVar->mSysVarID = static_cast<int32_t>(gModuleContext.mSysVar.size());
  gModuleContext.mSysVar.push_back(cclSysVar);
...
int32_t cclSignalGetID(const char* signalname)
{
  ...
  cclSignal->mSignalID = static_cast<int32_t>(gModuleContext.mSignal.size());
  gModuleContext.mSignal.push_back(cclSignal);
...
int32_t cclCanSetMessageHandler(int32_t channel, uint32_t identifier, void (*function) (cclCanMessage* message))
{
  ...
  if (!gModule)
  {
    return CCL_NODELAYER_UNDEFINED;
  }
...
int32_t cclValueBeginBulkUpdate(cclValueID valueID)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
  ...
  return valueEntity->BeginBulkUpdate();
}

int32_t cclValueEndBulkUpdate(cclValueID valueID)
{
  CCL_STATECHECK(eInitMeasurement | eRunMeasurement | eStopMeasurement);
  ...
  return valueEntity->EndBulkUpdate();
}
...
cclCallContextID cclCallContextMakePermanent(cclCallContextID ccID)
{
  ...
  VCallContext* cc = gModuleContext.mCallContexts.Get(ccID);
  if (cc == nullptr)
    return CCL_INVALIDCALLCONTEXTID;
