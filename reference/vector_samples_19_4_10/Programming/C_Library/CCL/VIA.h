...
09.01.2014   1.58  Tnr    Rudimentary ParameterService access added, mainly driven by the new node layer configuration
framework (EVAL00108361) 09.05.2014   1.59  Saa    Added extended version of functions for NLService 23.05.2014   1.60
Tnr    GetSynchronizedFilePath added 18.06.2014   1.61  Sjo    EVAL00114743 - added functions in VIA_NLServiceCANoeIL.h
...
15.10.2015   1.75  Cbo    EVAL00138856: Node layer interface (VIA) must be enhanced for allowing DLL generating system
variables and renaming them 21.10.2015   1.76  Jsd    EVAL00138874 - added FrEnableNodeTxEx 22.10.2015   1.77  Rue
EVAL00135958 - SV struct extensions 23.11.2015   1.79  Sjo    EVAL00138886 - added function in VIA_NLServiceCANoeIL.h
...
15.02.2016   1.85  Cbo    EVAL00142544 - added registration of VIAOnPDUStartTX by CreatePDURequestStartTX and set
VIASignalAccessMinorVersion = 14 10.03.2016   1.85  Rue    EVAL00143582 - Support SV type "data" for struct members
...
16.03.2016   1.86  Cbo    EVAL00143837 - Transfer property and Update Bit position must also be available for a signal
group 11.04.2016   1.87  Wwi    EVAL00143497 - enable PDU-support in AFDX_IL 11.04.2016   1.88  Cbo    EVAL00141989 -
Multiplexed-I-PDUs and Timings in VIA (VIA_Pdu.h 1.4) 23.05.2016   1.89  Srj    EVAL00145865 - PDU Streaming 4 FlexRay:
Add GetPDUService to VIA_FexRay 23.05.2016   1.90  Mkb    EVAL00148231 - VIA Interface for Global Time Information
...
06.07.2017   1.99  Bma    EVAL00156525 - Added functions to get and release the Simulink memory layout of System
Variables 26.09.2017   1.100 Jhn    EVAL00152038 - Added new VIASocketService2 interface 12.03.2018   1.101 Brs
CANOE-290257 - Added possibility to iterate through all system variables of a given namespace 04.06.2018   1.102 Brs
CANOE-291080 - OEMBackendAccess Request and Response 24.07.2018   1.103 Aa     CANOE-297133 - License bit should be
available for node layer 14.03.2018   1.104 Amo    CANOE-289941 - Support of Function Bus behind the classic VIA
interface 17.09.2018   1.105 Brs    CANOE-291080 - OEMBackendAccess Request and Response reworked - has never been used
so far (CANoe 299722) 14.01.2019   1.106 Brs    COE-844   - Access security configuration of TCP stacks
11.04.2019   1.108 Brs    COE-9108  - GetServiceFlags extended to provide information if RT is running standalone (used
by Security Manager  to detect RT/Standalone Modus for ZenZefi Access) 04.06.2019   1.109 Aa     COE-10190 - Provide
license information for Smart Charging CCS Test Packages EV/EVSE 26.06.2019   1.110 cns    COE-9903 - Linux support
...
14.01.2020   1.114 Aa     COE-16302 - Check valid Wibu licenses by giving the product code (and optional the major/minor
Version) - intended for non-CANoe licenses 15.11.2019   1.115 Chk/Fbo Support for Binding Transmitter for DOs 10.12.2019
Fbo    COE-15703 Added VIA Service for ADAS 19.03.2020   1.116 Rue    Added DistSim interface 01.08.2020   1.117 Bkd
COE-23525 - Extended DistSim interface 11.12.2020   1.118 Rue 25.01.2021   1.119 Tnn    COE-29367 - Added new
GetADASService2 interface 23.02.2021   1.120 Mto    COE-30879 Support SOME/IP Service Signals in VIA 08.04.2021   1.121
Dch    COE-32961 Make system variable accessible if namespace is concealed 05.08.2021   1.122 Aa     Introduce
versioning for VIAFbAnlyzService/VIAFbService 25.11.2021   1.123 Wan    Extended VIANodeType enum 25.11.2021   1.124 As
Integration Bus support added 11.01.2022   1.125 Chk    Add dynamic protocol id registration for
BindingTransmitterService 11.01.2022   1.126 Pr     Introduce network pipe objects 25.02.2022   1.127 jug    COE-42299 -
Added Security interface 11.04.2022   1.128 Flk    COE-42979 extend VATimer for performance monitoring
05.05.2022   1.128 koe    COE-45907 - Remove unused code in ERT WEC
01.08.2022   1.129 eln    COE-45692 - SIL Kit support added
23.12.2022   1.130 Bkd    COE-53436 - Remove DistSim
31.11.2023   1.131 Brs    COE-52870 - Update enum VIADBVersionInformation
15.02.2023   1.132 Pit    COE-54796
08.05.2023   1.133 ckefelian COE-57319: add a function to access the environment-make scenario name
23.06.2023   1.134 Roa    COE-48475 - Added function to create generic array without initial values
12.07.2023   1.134.1 Ope  COE-60695 - Add freeware support check
14.09.2023   1.135 Amo    COE-61817: add a function to retrieve a VIANode by name
13.22.2023   1.136 Gw     COE-65453: add a function to retrieve the current animation factor
27.10.2023   1.137 Amo    COE-64797: add a service to access the Autosar PDU Binding Block
22.01.2024   1.138 Mmt    COE-69158: AsrPDUIL - Disturbance functions for CRC with 8 byte
25.01.2024   1.139 jotto  COE-57714 - Parallel execution of Matlab models
25.01.2024   1.140 jotto  COE-60556: Add application model support
16.02.2024   1.141 Gw     COE-66735: Add variant of GetUserFilePath which supports encoding
15.03.2024   1.142 bma    COE-72560: Add Parameter to configure whether the VIASharedMemoryPage should exchange data at
t=0 24.04.2024   1.143 Roa    COE-74267 - Add function to get client handle from system variable 03.05.2024   1.144 Bma
COE-74084: add method VIASharedMemoryPage::DisableSchedulerTimer and VIASharedMemoryPage::Trigger 06.05.2024   1.145 Bma
COE-74084: add method VIASharedMemoryPage::RegisterWorkerFinishedCompletedHandler 12.05.2024   1.146 pmispelhorn
COE-67176 added IVIAFBindingMessageV2 23.05.2024   1.147 vispir COE-74043 added methode OnPreStart to NodeLayerAPI
...
class VIAServiceSignalAccessApi;
class VIASomeIpDOAccessApi;
class VIAAutosarPDUAccessApi;
...
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 116)
class VIADistSimService;
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 124)
class VIAIntegrationBus;
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 127)
class VIASecurity;
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 129)
class VIASilKit;
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 139)
class VIASharedMemoryPage;
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 140)
class VIAApplication;
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 146)
class IVIAFBindingMessageV2;
#endif
...
enum VIAResultValue
{
	...
	kVIA_IBUnspecifiedError = 200, // Deprecated, replaced by SIL Kit
	kVIA_IBNotSupported = 201,     // Deprecated, replaced by SIL Kit
	kVIA_IBNotImplemented = 202,   // Deprecated, replaced by SIL Kit
	kVIA_IBBadParameter = 203,     // Deprecated, replaced by SIL Kit

	kVIA_SilKitUnspecifiedError = 200,
	kVIA_SilKitNotSupported = 201,
	kVIA_SilKitNotImplemented = 202,
	kVIA_SilKitBadParameter = 203
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 126)

struct VIADomainTime
{
	VIATime timestamp;  // Time of a time domain in ns ("Absolute" time with respect to time scale's epoch)
	uint32 leapSeconds; // Leap seconds included in timestamp with respect to time scale's epoch
};

enum VIATimeScale
{
	kVIA_TimeScaleUndefined,
	kVIA_TimeScaleUtc,
	kVIA_TimeScaleTai,
	kVIA_TimeScalePerformanceCounter,
	kVIA_TimeScaleArbitrary
};

//
// A time domain a time sensitive network port can be member of. A network pipe is always connected to a specific time
// domain and timestamps attached to send inquiries are related to the domain's clock.
// In the future time sensitive network ports will be delivered packets containing timestamp values related to their
// individual time domain(s) they are member of.
// Domain clocks provide monotonically increasing absolute nanosecond timestamp values with time intervals measured
// according to the domain's time scale definition with or without leap seconds included and in relation to a fixed
// point in time = epoch.
//
class VIATimeDomain
{
public:
	VIASTDDECL GetTimeScale(VIATimeScale* pTimeScale) = 0;
};
...
public:
	...
	VIASTDDECL MoveToPreviousElement() = 0;
#endif
};
...
#define VIDB_DECLARE_ATTRIBUTE_HOLDER                                                                \
  public:                                                                                              \
    ...
    VIASTDDECL GetAttribute(const char* pAttrName, VIDBAttribute** attribute) = 0;                     \
    ...
    VIASTDDECL GetAttributeType(uint32* pType, const char* pAttrName) const = 0;                       \
    /* Gets the numeric value of specified attribute                                  */               \
    /* Returns kVIA_OK: attribute was found and the value was given back              */               \
    /*   kVIA_DBAttributeNameNotFound: name of attribute can't found in database      */               \
    /*   kVIA_Failed or kVIA_ObjectInvalid or kVIA_DBUnspecificError: function failed */               \
    VIASTDDECL GetAttributeValue(double* pValue, const char* pAttrName) const = 0;                     \
    /* Gets the string value of specified attribute                                   */               \
    /* Returns kVIA_OK: attribute was found and the value was given back              */               \
    /*   kVIA_DBAttributeNameNotFound: name of attribute can't found in database      */               \
    /*   kVIA_BufferToSmall: specified buffer is to small for value                   */               \
    /*   kVIA_Failed or kVIA_ObjectInvalid or kVIA_DBUnspecificError: function failed */               \
    VIASTDDECL GetAttributeString(char* pBuffer, int32 bufferLength, const char* pAttrName) const = 0; \
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 126)
//
// Interface classes for hardware-based pipes and related sending functionality
//
// Network pipes allow for HW-based precise send time scheduling by evaluating timestamps pre-calculated by the
// application (CANoe) for each send request. Each pipe has its own HW queue that is configured, monitored and driven to
// prevent under- and overruns.
// A network pipe is designed to be bus system independent (although it is currently only available for Ethernet
// networks)
//
// These interfaces will be extended on demand.
//

//
// A memory buffer wraps a portion of contiguous memory of a specific size that can be retrieved read-only.
// Its data must never be altered by the code retrieving it.
//
class VIAMemoryBuffer
{
public:
	VIASTDDECL GetData(const uint8** ppData, uint32* pSize) const = 0;
};

typedef VIDBIterator<VIAMemoryBuffer> VIAMemoryBufferIterator;

//
// A network buffer contains a list of memory buffers accessible by an iterator. This allows for the aggregation and
// concatenation of many buffers coming from different protocol layers, each embedding the data from its upper layer
// without the need of copying. The full buffer represents the data entity on the lowest level (e. g. Ethernet MAC
// layer).
// Functions that take a network buffer as an argument must consume *all* data from the memory buffers, or *no* data at
// all.
// So a memory buffer iterator can point to either the start or the end of the list of memory buffers after the function
// returns.
//
class VIANetworkBuffer
{
public:
	VIASTDDECL GetUserContext(uint32* pContext) const = 0;

	VIASTDDECL GetMemoryBufferIterator(VIAMemoryBufferIterator** iterator) = 0;
};

typedef VIDBIterator<VIANetworkBuffer> VIANetworkBufferIterator;

//
// A network buffer list provides access to a list of network buffers accessible by an iterator. This list is always
// treated as a whole, which means that either *all* of the associated network buffers with their data are consumed by
// the function that takes them as an argument, or *none*.
// So a network buffer iterator can point to either the start or the end of the list of network buffers after the
// function completes its operation.
//
class VIANetworkBufferList
{
public:
	VIASTDDECL GetTimestamp(VIADomainTime* ppTime) const = 0;
	VIASTDDECL GetDataLength(uint32* pLength) const = 0;

	VIASTDDECL GetNetworkBufferIterator(VIANetworkBufferIterator** iterator) = 0;
};

typedef VIDBIterator<VIANetworkBufferList> VIANetworkBufferListIterator;
...
// networks).
//
class VIANetworkPipe
{
public:
	//
	// When all network buffers handed over are successfully consumed by the pipe the function returns kVIA_OK. If not all
	// buffers can be consumed at this time the function returns kVIA_IoPending and the iterator is saved for further
	// (asynchronous) processing.
	// The completion status of the remaining buffer lists is then signaled by the call of
	// VINetworkPipeCallbacks::OnNetworkPipeOutputComplete. The iterator points beyond the last buffer list successfully
	// consumed by the pipe. At this point the pipe is ready to consume one or more new buffer lists by means of the
	// Output function.
	//
	VIASTDDECL Output(VIANetworkBufferListIterator* pNetworkBufferLists, uint32* outputFlags) = 0;
};

class VIANetworkPipeCallbacks
{
public:
	//
	// This completion function is called whenever the previous call of VIANetworkPipe::Output could not complete
	// synchronously (it returned kVIA_IoPending).
	// It signals the completion status of the buffer lists handed over to the pipe. The iterator points beyond the last
	// buffer list successfully consumed by the pipe. At this point the pipe is ready to consume one or more new buffer
	// lists by means of the Output function.
	//
	VIASTDDECL OnNetworkPipeOutputComplete(VIANetworkPipe* pPipe,
		VIAResult result,
		uint32 outputCompleteFlags,
		VIANetworkBufferListIterator* pNetworkBufferLists) = 0;
};
...
public:
	...
	VIASTDDECL GetVersion(uint32* busInterfaceType, // [OUT] Type (see enum VIABusInterfaceType)
		int32* majorversion,
		int32* minorversion) = 0; // [OUT] Version
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 128)
	// Activates or deactivates accuracy monitoring of the timer
	VIASTDDECL SetTimerAccuracyMonitoringActive(bool active) = 0; // [IN] Flag to activate or deactivate timer monitoring

	// Timer accuracy (if timer monitoring is active)
	VIASTDDECL GetLastTimerAccuracyNS(VIATime* accuracy) = 0; //[OUT] the current timer accuracy
#endif                                                      // VIAMinorVersion >= 128
};
...
public:
	...
	// Obsolete (As version 1.20): This function is replaced by the attribute retrieval functions of VIANode
	VIASTDDECL GetDBAttributeString(
		char* pBuffer, int32 bufferLength, uint32 objectType, const char* objectName, const char* pAttrName) = 0;
...
enum VIANodeType
{
	...
	kVIA_FBParticipantNode = 1, // Node in the communication setup for participants (Function Bus)
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 123)
	kVIA_FBCommunicationNode = 2, // Node in the communication setup for active communication (Function Bus)
	kVIA_FBObserverNode = 3       // Node in the communication setup for passive observers (Function Bus)
#endif
};
#endif
...
public:
	...
	VIASTDDECL ProcessOEMBackendRequest(VIAOEMBackendRequestHandlerType requestHandlerType,
		const char* requestHandlerId,
		uint32 requestHandlerIdLength,
		const char* requestHandlerParameter,
		uint32 requestHandlerParameterLength,
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 132)
	// Returns a CAPL function handle. The handle stays valid until end of
	// measurement or a call of ReleaseCaplFunction. This method is best
	// called at InitMeasurement.
	VIASTDDECL GetCaplFunction2(VIACaplFunction** caplfcts, // the created handle
		const char* functionName,
		const char* parTypeList,
		char resulttype) = 0; // name of the function
#endif
};
...
public:
	...
	// signal is found.
	VIASTDDECL GetSignal(const char* name, VIDBSignalDefinition** signal) = 0;
	// Iterates over signals
	VIDB_DECLARE_ITERATABLE(SignalDefinition)
		// Gets access to attributes defined in a database:
		// Returns the attribute / the attribute type / the numeric value / the string value
...
public:
	...
	// Supported by CAPL-on-Board: No
	VIASTDDECL GetPhysicalValue(unsigned char* rawData, double& physValue) const = 0;
	...
	// Supported by CAPL-on-Board: No
	VIASTDDECL GetRawValue(unsigned char* rawData, ::uint64& rawValue) const = 0;

	// Sets the signal value with the physical value
	// Supported by CAPL-on-Board: Yes
	VIASTDDECL SetPhysicalValue(double physValue, unsigned char* rawData) const = 0;
	...
	// Supported by CAPL-on-Board: Yes
	VIASTDDECL SetRawValue(::uint64 rawValue, unsigned char* rawData) const = 0;
	...
	// Supported by CAPL-on-Board: No
	VIASTDDECL GetRawValueByDouble(unsigned char* rawData, double& rawValue) const = 0;

	// This method can be used to set the raw value for all types of signals.
	// Supported by CAPL-on-Board: No
	VIASTDDECL SetRawValueByDouble(double rawValue, unsigned char* rawData) const = 0;
#endif
	...
	// Supported by CAPL-on-Board: No
	VIASTDDECL GetRawValueByteArray(unsigned char* rawData,
		uint32 rawDataLength,
		unsigned char* rawValue,
		uint32 rawValueLength) = 0;

	// This methods can be used to set the raw values for signals > 64 bit.
	// Supported by CAPL-on-Board: No
	VIASTDDECL SetRawValueByteArray(unsigned char* rawValue,
		uint32 rawValueLength,
	...
	// Returns whether this signal is multiplexed by the given value for its multiplexer signal (only valid if this
	// signal is multiplexed)
	// Supported by CAPL-on-Board: No
	VIASTDDECL IsMultiplexedByValue(uint32 value, bool& isMultiplexed) const = 0;

	// Returns whether this signal is currently valid in the rawData according to the multiplexer value in the rawData
	// (only valid if this signal is multiplexed)
	// Supported by CAPL-on-Board: No
	VIASTDDECL IsValidMultiplexedSignal(unsigned char* rawData,
		uint32 rawValueLength,
...
enum VIADBVersionInformation
{
	...
	kVIA_FormatVersion_AUTOSAR_4_3 = 213,
	kVIA_FormatVersion_AUTOSAR_4_4 = 214

	,
	kVIA_FormatVersion_AUTOSAR_R19_11 = 216 // ASR 4.5
	,
	kVIA_FormatVersion_AUTOSAR_R20_11 = 217,
	kVIA_FormatVersion_AUTOSAR_R21_11 = 218,
	kVIA_DBC = 100001
};
#endif
class VIDBDatabase
...
public:
	...
	VIASTDDECL SetIntegerArray(const ::int64* x, int32 length, VIASysVarClientHandle client) = 0; // [IN] Integer array
	// [IN] length of array
	// [IN] Owner of SV
	VIASTDDECL GetIntegerArray(::int64* x, int32 length) = 0; // [OUT] Integer array [IN] length of array

	VIASTDDECL SetFloatArray(const double* x, int32 length, VIASysVarClientHandle client) = 0; // [IN] Float array [IN]
	// length of array [IN]
	// Owner of SV
	...
	VIASTDDECL SetData(const uint8* x, int32 length, VIASysVarClientHandle client) = 0; // [IN] byte array [IN] length of
	// array [IN] Owner of SV
	...
	// Get the memory layouts of the SV in CANoe and Simulink. The parameters <blockStartsCanoe>, <blockStartsSimulink>,
	// and <blockSizes> are allocated in this function and must later be released via the function
	// ReleaseSimulinkMemoryLayout.
	VIASTDDECL GetSimulinkMemoryLayout(uint32* numBlocks,
		uint32** blockStartsCanoe,
		uint32** blockStartsSimulink,
		uint32** blockSizes) = 0;
...
public:
	...
	VIASTDDECL AddLinearEncoding(
		double factor, double offset, const ::int64* minValue, const ::int64* maxValue, const char* unit) = 0;
...
public:
	...
	VIASTDDECL DefineAsInt(const ::int64* initialValue,
		int32 bitLength,
		bool isSigned,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	VIASTDDECL DefineAsFloat(const double* initialValue,
		int32 bitLength,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	VIASTDDECL DefineAsIntArray(const ::int64* initialValues,
		int32 arrayLength,
		int32 bitLength,
		bool isSigned,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	VIASTDDECL DefineAsFloatArray(const double* initialValues,
		int32 arrayLength,
		int32 bitLength,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	VIASTDDECL DefineAsString(int32 maxLength,
		const char* initialValue,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	VIASTDDECL DefineAsGenericArray(int32 arrayLength,
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 77)
	VIASTDDECL DefineAsVariableLengthArray(int32 arrayLength,
		int32 minLength,
		int32 maxLength,
		VIASVArrayElementDefinition* arrayElementDefinition,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	...
	VIASTDDECL DefineAsData(const ::uint8* initialValue,
		int32 byteCount,
		VIASVStructMemberDefinition** memberDefinition) = 0;
#endif
};
...
public:
	...
	VIASTDDECL AddIntMember(const char* name,
		const ::int64* initialValue,
		int32 bitLength,
		bool isSigned,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	VIASTDDECL AddFloatMember(const char* name,
		const double* initialValue,
		int32 bitLength,
		VIASVStructMemberDefinition** memberDefinition) = 0; // only bit lengths 32 and 64 are
	// supported
	VIASTDDECL AddIntArrayMember(const char* name,
		const ::int64* initialValues,
		int32 arrayLength,
		int32 bitLength,
		bool isSigned,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	VIASTDDECL AddFloatArrayMember(const char* name,
		const double* initialValues,
		int32 arraylength,
		int32 bitlength,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	VIASTDDECL AddStringMember(const char* name,
		int32 maxLength,
		const char* initialValue,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	VIASTDDECL AddGenericArrayMember(const char* name,
		int32 arrayLength,
		VIASVArrayElementDefinition* arrayElementDefinition,
		VIASVStructMemberDefinition** memberDefinition) = 0;
	// the struct path is [NamespaceName::]*StructName
	VIASTDDECL AddStructMember(const char* name,
		const char* structPath,
		int32 bitCount,
		VIASVStructMemberDefinition** memberDefinition) = 0;

	// must only be called after Define(). Utility to use the bit count in further references to the structs (e.g.
	// AddStructMember).
	...
	VIASTDDECL AddVariableLengthArrayMember(const char* name,
		int32 arrayLength,
		int32 minLength,
		int32 maxLength,
		VIASVArrayElementDefinition* arrayElementDefinition,
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 85)
	VIASTDDECL AddDataMember(const char* name,
		const ::uint8* initialValues,
		int32 byteCount,
		VIASVStructMemberDefinition** memberDefinition) = 0;
#endif
};
...
public:
	...
	// change its value.
	VIASTDDECL AddVariable(const char* name,
		VIASysVarType type,
		bool readOnly,
	...
	VIASTDDECL AddArrayVariable(const char* name,
		VIASysVarType type,
		uint32 arrayLength,
		bool readOnly,
		VIASysVarClientHandle client,
	...
	VIASTDDECL AddIntVariableWithInitialValue(const char* name,
		int32 initialValue,
		bool readOnly,
		VIASysVarClientHandle client,
		VIASystemVariable*& variable) = 0;
	VIASTDDECL AddFloatVariableWithInitialValue(const char* name,
		double initialValue,
		bool readOnly,
		VIASysVarClientHandle client,
		VIASystemVariable*& variable) = 0;
	VIASTDDECL AddStringVariableWithInitialValue(const char* name,
		const char* initialValue,
		bool readOnly,
		VIASysVarClientHandle client,
		VIASystemVariable*& variable) = 0;
	VIASTDDECL AddIntArrayVariableWithInitialValue(const char* name,
		const int32* initialValue,
		int32 length,
		bool readOnly,
		VIASysVarClientHandle client,
		VIASystemVariable*& variable) = 0;
	VIASTDDECL AddFloatArrayVariableWithInitialValue(const char* name,
		const double* initialValue,
		int32 length,
		bool readOnly,
		VIASysVarClientHandle client,
		VIASystemVariable*& variable) = 0;
	VIASTDDECL AddDataVariableWithInitialValue(const char* name,
	...
	VIASTDDECL AddStructVariable(const char* name,
		const char* structPath,
		bool readOnly,
		VIASysVarClientHandle client,
		VIASystemVariable*& variable) = 0;
	VIASTDDECL AddGenericArrayVariable(const char* name,
		int32 arrayLength,
		VIASVArrayElementDefinition* arrayElementDefinition,
		bool readOnly,
		VIASysVarClientHandle client,
	...
	VIASTDDECL AddIntVariable(const char* name,
		bool isSigned,
		bool is64bit,
		bool readOnly,
		VIASysVarClientHandle client,
		VIASystemVariable*& variable) = 0;
	VIASTDDECL AddIntVariableWithInitialValueEx(const char* name,
		::int64 initialValue,
		bool isSigned,
		bool is64bit,
		bool readOnly,
	...
	VIASTDDECL AddStringVariableWithInitialValueEx(const char* name,
		const char* initialValue,
		uint32 codepage,
		bool readOnly,
		VIASysVarClientHandle client,
	...
	VIASTDDECL AddStructVariableWithMemberInitValues(const char* name,
		const char* structPath,
		bool readOnly,
		VIASysVarClientHandle client,
		VIASystemVariableMemberInitValues* memberInitValues,
		VIASystemVariable*& variable) = 0;
	// Extension of interface method AddGenericArrayVariable(). It allows for initialization of specific elements with
	// values which are independent of generic start values defined in the corresponding element prototype.
	VIASTDDECL AddGenericArrayVariableWithMemberInitValues(const char* name,
		int32 arrayLength,
		VIASVArrayElementDefinition* arrayElementDefinition,
		bool readOnly,
		VIASysVarClientHandle client,
...
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 77)
	VIASTDDECL AddGenericArrayVariableWithoutBinaryLayout(const char* name,
		int32 arrayLength,
		VIASVArrayElementDefinition* arrayElementDefinition,
		bool readOnly,
		VIASysVarClientHandle client,
		VIASystemVariableMemberInitValues* memberInitValues,
		VIASystemVariable*& variable) = 0;
	VIASTDDECL AddVariableLengthArrayVariable(const char* name,
		int32 arrayLength,
		int32 minLength,
		int32 maxLength,
		VIASVArrayElementDefinition* arrayElementDefinition,
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 121)
	// Retrieves a subnamespace of the concealed namespace. The path may contain several
	// hierarchies, separated with '::'.
	VIASTDDECL GetNamespaceEx(const char* path, VIANamespace*& nameSpace, bool isConcealed) = 0;

	// Retrieves a variable in the concealed namespace. The path may contain subnamespaces,
	// separated with '::'.
	VIASTDDECL GetVariableEx(const char* path, VIASystemVariable*& variable, bool isConcealed) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 134)
	// Similar to AddGenericArrayVariable() but does not implicity set default init values.
	VIASTDDECL AddGenericArrayVariableWithoutInitValues(const char* name,
		int32 arrayLength,
		VIASVArrayElementDefinition* arrayElementDefinition,
		bool readOnly,
		VIASysVarClientHandle client,
...
public:
	...
	VIASTDDECL SetIntegerArray(const int32* x, int32 length, VIASysVarClientHandle client) = 0; // [IN] Integer array [IN]
	// length of array [IN]
	// Owner of SV
	...
	VIASTDDECL SetData(const uint8* x, int32 length, VIASysVarClientHandle client) = 0; // [IN] byte array [IN] length of
	// array [IN] Owner of SV
	VIASTDDECL GetData(uint8* buffer, int32 bufferSize, int32* copiedBytes) = 0; // [OUT] byte array [IN] length of buffer
	// [OUT] number of copied bytes
#endif
	...
	VIASTDDECL SetStringWithEncoding(const char* text,
		VIASysVarClientHandle client,
		uint32 codepage) = 0; // [IN] String value of SV  [IN] Owner of SV [IN] codepage
	VIASTDDECL GetStringInEncoding(char* buffer, int32 bufferLength, uint32 codepage) = 0; // [OUT] String value of SV
	// [IN] Buffer length [IN]
	// codepage
#endif
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 121)
	// Sets the callback object of the system variable (see VIAOnSysVar) for variables in concealed namespaces
	// Note: The sink-object will be referenced!
	VIASTDDECL SetSinkEx(VIAOnSysVar* sink, bool isConcealed) = 0;
	// used for types data and struct - access concealed namespace
	VIASTDDECL SetDataEx(const uint8* x, int32 length, VIASysVarClientHandle client, bool isConcealed) = 0; // [IN] byte
	// array [IN]
	// length of
	// array [IN]
	// Owner of SV
	VIASTDDECL GetDataEx(uint8* buffer, int32 bufferSize, int32* copiedBytes, bool isConcealed) = 0; // [OUT] byte array
	// [IN] length of
	// buffer [OUT]
	// number of copied
	// bytes
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 143)
	VIASTDDECL GetClientHandle(VIASysVarClientHandle* client) = 0;
#endif
};
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 118)
	// Register a client which doesn't use the connectivity feature set
	// Those clients need to register themselves (with two DLLs) both in RT and Anlyz. The messages
	// need to set the protocol ID to the one returned by the RegisterNonCFSClient call.
	// However, all non-CFS clients use the same protocol ID, and the client will receive every
	// non-CFS message. You have to filter the messages yourself, e.g. through a binding message
	// attribute.
	VIASTDDECL RegisterNonCFSClient(VIAFbBindingTransmitterClient* client, uint32* outProtocolID) = 0;
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 125)
	VIASTDDECL RegisterWithDynamicProcID(VIAFbBindingTransmitterClient* client,
		const char* bindingBlockName,
		uint32* outProtocolID) = 0;
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 146)
	VIASTDDECL SendBindingMessageV2(const IVIAFBindingMessageV2* inMsg) = 0;
#endif
};
#endif
...
const uint32 kVIA_SmartChargingCCSEVAvailable = 0x00000400; // License for Smart Charging CCS Test Package EV is
// available
#endif
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 58)
// visas didn't want to have a namespace ParameterServer, therefore ParameterServer::VIAService was renamed to
// VIAParameterServerService
...
public:
	...
	VIASTDDECL GetVariantPropertyByFullyQualifiedName(const char* pFullyQualifiedName, //[IN] the fully qualified name
		VIAVariantProperty** pVariantProperty) = 0; //[OUT] the address to
...
public:
	...
	VIASTDDECL GetVariantProperties(VIAVariantProperties** pVariantProperties) = 0; //[OUT] the address to the variant
	// properties
};
...
public:
	...
	// Return values
	//   kVIA_OK                The node layer configuration parameter server scope is written to address
	//                          pNodeLayerConfigurationScope
	//   kVIA_Failed            Unspecific error, nothing is written to address pNodeLayerConfigurationScope
	VIASTDDECL GetNodeLayerConfigurationScope(VIAScope** pNodeLayerConfigurationScope) = 0; //[OUT] the address to the
	// scope

// Gets the parameter server scope to the over given ID
// Return values
//   kVIA_OK                The parameter server scope could be found and the scope pointer is written to address
//                          pParameterServerScope
//   kVIA_Failed            The parameter server scope could not be found, nothing is written to address
//                          pParameterServerScope
...
// Callback which can be called in the core processing loop after sys vars / env vars / value entities have been
// updated. See VIAService::RegisterCoreProcessingFunction
...
public:
	...
	// Write a message to the Write Window which is known by CANoe and the help system. (Maps to CANoeWriteParams.)
	VIASTDDECL WriteKnownMessage3(
		uint32 moduleId, uint32 messageId, const char* param1, const char* param2, const char* param3) = 0;
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 118)
// Defines execution on a background thread. Implemented by the client.
// Note that most VIA API functions are not allowed to be called on
// a background thread, except those where it is explicitly mentioned.
class VIAThreadFunction
{
public:
	VIASTDDECL Execute() = 0;
};

// Priority for a background thread
enum VIAThreadPriority
{
	// the values Lowest to TimeCritical correspond to the Windows THREAD_PRIORITY_ constants
	kVIAThreadPriority_Lowest = 0,
	kVIAThreadPriority_BelowNormal,
	kVIAThreadPriority_Normal,
	kVIAThreadPriority_AboveNormal,
	kVIAThreadPriority_Highest,
	kVIAThreadPriority_TimeCritical,
	// use the same priority as the RT thread (which can be set through the can.ini)
	kVIAThreadPriority_RTThread,
};

// Represents a background thread. Note that most VIA API functions are not allowed to be called on
// a background thread, except those where it is explicitly mentioned.
class VIAThread
{
public:
	// Release may only be called on the main thread. It joins the BG thread, i.e. it waits for the
	// BG thread to have finished its Execute method. It is the responsability of the client to
	// ensure that the BG thread finishes as soon as possible.
	VIASTDDECL Release() = 0;
	// Starts the execution of the code on the thread. This must be called once on the creating thread.
	VIASTDDECL Start() = 0;
	// Set the priority of the thread. By default, the thread has priority 'normal'.
	// When the thread is done and returned to the thread pool, the priority is reset automatically.
	// This should be called *on* the background thread since it won't work if the thread isn't running yet.
	VIASTDDECL SetPriority(VIAThreadPriority priority) = 0;
};

// Represents an event trigger. An instance is used if the client receives events on a background thread
// and wants to trigger the dispatching of those events to CANoe on the main thread.
// In CANoe, the event trigger implements an event provider.
class VIAEventTrigger
{
public:
	// Release may only be called on the main thread.
	VIASTDDECL Release() = 0;
	// Notifies that (at least) one event has been received and is ready for dispatching.
	// This function is intended to be called on a background thread.
	VIASTDDECL EventArrived() = 0;
};

// Dispatches events received on a background thread after the event trigger has been
// notified. Implemented by the client.
// Dispatching the events will usually mean passing the event data to CANoe.
// The functions will be called on the main thread, so the entire VIA API is available
// for this, while the background thread typically just calls EventArrived on the trigger.
class VIAEventDispatcher
{
public:
	// Dispatch the first available received event
	VIASTDDECL DispatchSingleEvent() = 0;
	// Called after an event has been dispatched
	VIASTDDECL HasMoreEvents(bool* outHasEvents) const = 0;
};
#endif
...
public:
	...
	// Supported by CAPL-on-Board: No
	VIASTDDECL SetNLServiceApi(VIANLServiceApi* apNLServiceMember, VIANode* apMyNode) = 0;
	...
	enum VIASocketServiceType
	{
		...
		kVIA_SocketServiceDefault = 3 // use kVIA_SocketServiceWinsock or kVIA_SocketServiceIPB as defined in node
		// configuration
	};
	...
	VIASTDDECL GetDiagDescription(const char* aEcuQualifier_in,
		char* apEcuId_out,
		int32 aLenEcuId,
		char* apVariantQualifier_out,
		int32 aLenVariantQualifier,
		char* apLanguage_out,
		int32 aLenLanguage,
		char* apPath_out,
	...
	//   kVIA_ObjectNotFound    the given file name was not found in the list of configured user files (in distributed
	//   case). kVIA_ParameterInvalid  one ore more of the given parameters is invalid (For example: filename or
	//   pathBuffer is
	...
	// Supported by CAPL-on-Board: No
	VIASTDDECL GetSystemVariablesDefaultClientHandle(VIASysVarClientHandle* handle, // [OUT] the default handle of the
		// module
  ...
  //   kVIA_Failed            unspecific error
  // Supported by CAPL-on-Board: No
	VIASTDDECL RegisterUserFile(const char* filePath, // [IN]   The file path of the user file on the user PC (absolute or
		// relative to cfg dir)
		bool isTempRegistration) = 0; // [IN]   if true, registration is only valid during this
	// measurement;
	//        otherwise user file is added to user file list in
	//        CANoe configuration
#endif
  ...
  //   kVIA_Failed            Unspecific error
	...
	VIASTDDECL IncrementTimerBase(VIATime newTimeBaseTicks, // [IN] new time base (1 tick == 1 ns)
		int32 numberOfTicks) = 0; // [IN] resolution in steps for the increment specified in
	// first parameter
...
//   kVIA_Failed            Unspecific error
	...
	// Supported by CAPL-on-Board: No
	VIASTDDECL ReleaseCAPLonBoardConstruction(VIACAPLonBoardConstruction* cob) = 0; // [IN]  The API object to be
	// released.
#endif
  ...
  // Retrieves the API object for tests
	...
	VIASTDDECL GetParameterServerService(VIAParameterServerService** pVIAParameterServerService) = 0; //[OUT] the VIA
	// parameter server
	// service
#endif
  ...
  // Identifies the execution mode
	...
	// Registers the Node Layer for service activity
	// Supported by CAPL-on-Board: Yes
	VIASTDDECL SetNLServiceApi2(VIANLServiceApi* apNLServiceMember,
		VIANode* apMyNode,
	...
	//   kVIA_ParameterInvalid         one ore more of the given parameters is invalid (For example: filename or
	//                                 pathBuffer is a nullptr, or pathBufferLength is zero)
	...
	// Supported by CAPL-on-Board: No
	VIASTDDECL GetSynchronizedFilePath(const char* filename, // [IN]  The absolute or relative filepath of the
		// synchronized file (example: 'settings.ini', 'C:\temp.txt')
		char* pathBuffer, // [OUT] The full path of the synchronized file is copied to this
		// buffer
	...
	// Get the client which currently delivers the bus context upon GetBusContext() in CAPL (only for restoration
	// purposes) Supported by CAPL-on-Board: No
	...
	// Set the current client which delivers the bus context upon GetBusContext() in CAPL (note: use only a pointer
	// retrieved with one of the two previous get functions)
	// Supported by CAPL-on-Board: No
	...
	// Supported by CAPL-on-Board: No
	VIASTDDECL GetFunctionBusService(VIAFbViaService** outFbViaService, int32 majorversion, int32 minorversion) = 0;
	...
	//   productVersionMajor/productVersionMinor optional arguments:
	//   for subscription only license, zero values can be given to CANoe
	// Return values:
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 116)
	// Retrieves the API object for DistSim access
	VIASTDDECL GetDistSimService(VIADistSimService** pService, int32 majorversion, int32 minorversion) = 0;
	// Release a previously obtained service instance
	VIASTDDECL ReleaseDistSimService(VIADistSimService* pService) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 117)
	VIASTDDECL CreateTimer2(VIATimer** timer, VIANode* handle, VIAOnTimerSink* sink, const char* name, bool synchronous) =
		0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 118)
	// Creates a background thread to execute code on it. The background thread may e.g. be used to
	// receive events through an event provider.
	// Note that most VIA API functions are not allowed to be called on
	// a background thread, except those where it is explicitly mentioned.
	// The thread must be explicitly started with a call to Start() on the VIAThread instance.
	// The thread name can have at most 15 bytes + a terminating 0 on Linux.
	VIASTDDECL CreateBGThread(VIAThreadFunction* threadFunction, const char* name, VIAThread** outThread) = 0;
	// Creates an event trigger for receiving events on a background thread.
	// The method can currently only be called before the measurement is started.
	// When you receive an event, store it in a queue and call EventArrived on the event trigger. Then,
	// the dispatcher methods will be called on the main thread.
	VIASTDDECL CreateEventTrigger(VIAEventDispatcher* eventDispatcher, VIAEventTrigger** outEventTrigger) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 119)
	// Retrieves the API object for ADAS access
	VIASTDDECL GetADASService2(VIAADASService** ppService, int32 majorversion, int32 minorversion) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 120)
	VIASTDDECL GetServiceSignalAccessApi(VIAServiceSignalAccessApi** aSignalAccessApi,
		VIANode* aNode,
		int32 majorversion,
		int32 minorversion) = 0;
#endif
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 124)
	// Retrieves the API object for integration bus access in the requested version. If available, an API object with
	// a compatible version is returned, otherwise the function fails with error code kVIA_WrongVersion.
	VIASTDDECL GetIntegrationBusInterface(VIAIntegrationBus** ib, // [OUT] The returned API object for integration bus
		// access
		int32 majorversion,     // [IN]  Major version of the requested API object.
		int32 minorversion      // [IN]  Minor version of the requested API object.
	) = 0;

	// Release the given API object for integration bus access.
	VIASTDDECL ReleaseIntegrationBusInterface(VIAIntegrationBus* ib // [IN] The API object, that should be released
	) = 0;

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 126)
	VIASTDDECL GetSimulationTimeDomain(VIATimeDomain** ppTimeDomain) = 0;
	VIASTDDECL GetCurrentDomainTime(VIATimeDomain* pTimeDomain, VIADomainTime* pRetAbsTime) const = 0;

	VIASTDDECL CreateNetworkPipe(VIABusInterfaceType busType,
		VIAChannel channel,
		VIAHwChannel hwChannel,
		VIATimeDomain* pTimeDomain,
		uint32 bitrate,
		VIANetworkPipeCallbacks* pCallbacks,
		VIANetworkPipe** ppPipe) = 0;
	VIASTDDECL ReleaseNetworkPipe(VIANetworkPipe* pPipe) = 0;
#endif
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 127)
	// Retrieves the object for Security Manager Access.
	VIASTDDECL GetSecurity(VIASecurity** security) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 129)
	// Retrieves the API object for SIL Kit access in the requested version. If available, an API object with
	// a compatible version is returned, otherwise the function fails with error code kVIA_WrongVersion.
	VIASTDDECL GetSilKitInterface(VIASilKit** silKit, // [OUT] The returned API object for the SIL Kit access
		int32 majorversion, // [IN]  Major version of the requested API object.
		int32 minorversion  // [IN]  Minor version of the requested API object.
	) = 0;

	// Release the given API object for the SIL Kit access.
	VIASTDDECL ReleaseSilKitInterface(VIASilKit* silKit // [IN] The API object, that should be released
	) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 133)
	// Get the name of the environment-make scenario name
	VIASTDDECL GetEnvironmentMakeScenarioName(char* buffer, int32 bufferLength) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 135)
	// Get node by name and by the attached network. Return values:
	//   kVIA_OK                       the node was found
	//   kVIA_ObjectNotFound           the node was not found
	//   kVIA_ParameterInvalid         nodeName is a nullptr
	//   kVIA_FunctionNotImplemented   function not implemented
	VIASTDDECL GetNode(const char* nodeName,    // [IN]   The name of the node
		const char* networkName, // [IN]   The name of the network to which the node is connected. If this
		// is a nullptr, the first network assignment of the node is chosen.
		VIANode** outNode) = 0;  // [OUT]  The returned node
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 136)
	// Get the animation factor (1.0 if CANoe is in real mode)
	VIASTDDECL GetAnimationFactor(double* animationFactor) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 136)
	VIASTDDECL GetSomeIpDOAccessApi(VIASomeIpDOAccessApi** someIpDOAccessApi, int32 majorversion, int32 minorversion) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 137)
	VIASTDDECL GetAutosarPDUAccessApi(VIAAutosarPDUAccessApi** autosarPduAccessApi,
		int32 majorversion,
		int32 minorversion) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 139)
	/// @brief Describes the SharedMemory version
	using VIASharedMemoryVersion = int32;

	/// @brief Enum denoting the type of the underlying SharedMemory type that shall be used
	enum class VIASharedMemoryType
	{
		eInterProcess = 0,
		eIntraProcess = 1,
	};

	/// @brief Enum describing the buffer type that is used in the SharedMemoryPage is used.
	enum class VIASharedMemoryBufferType
	{
		eSingleBuffered = 0,
		eDoubleBuffered = 1,
	};

	/// @brief Enum describing the direction in which a SharedMemoryPage is used.
	enum class VIASharedMemoryDirection
	{
		eRtkWriteClientRead = 0,
		eRtkReadClientWrite = 1,
	};

	/// @brief Enum denoting the type of the scheduler that is used for SharedMemory data exchange
	enum class VIASharedMemorySchedulerType
	{
		eTriggeredScheduler = 0,    // scheduling needs explicit trigger from client
		eOversamplingScheduler = 1, // cyclic timer with oversampling w.r.t. the client update rate
		eComplexTimerScheduler = 2, // complex scheduler that can also handle overruns
	};

	/// @brief Creates a new SharedMemoryPage instance
	/// @param[in] smType  The type of shared memory to create
	/// @param[in] name  The name of the page, must be unique
	/// @param[in] bufferType  The buffer type of the page
	/// @param[in] direction  Whether this page is read or written by CANoe
	/// @param[in] schedulerType  The scheduler used by the created page
	/// @param[in,out] version  The version of the SM layout
	/// @param[out] page  The created SM page
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL CreateSharedMemoryPage(VIASharedMemoryType smType,
		const char* name,
		VIASharedMemoryBufferType bufferType,
		VIASharedMemoryDirection direction,
		VIASharedMemorySchedulerType schedulerType,
		VIASharedMemoryVersion& version,
		VIASharedMemoryPage*& page) = 0;

	/// @brief Releases a given SharedMemoryPage instance
	/// @param[in] page  the page to release
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL ReleaseSharedMemoryPage(VIASharedMemoryPage* page) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 140)
	/// @brief Retrieves a default client handle for accessing system variables
	/// @param[out] handle  The default sysVar client handle
	/// @param[in] app  The application to create the default handle for
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL GetSystemVariablesDefaultClientHandleAppModel(VIASysVarClientHandle* handle, VIAApplication* app) = 0;

	/// @brief Creates a VIASignalAccessApi instance for the use with ApplicationModel-DLLs
	/// @param[out] signalAccess  The created instance
	/// @param[in] channel  The channel to access
	/// @param[in] busType  The type of the underlying bus
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL CreateSignalAccessApi(VIAChannel channel,
		VIABusInterfaceType busType,
		VIASignalAccessApi*& signalAccess) = 0;

	/// @brief Destroys a previously created VIASignalAccessApi instance, identified by channel and busType
	/// @param[in] channel  The channel of the VIASignalAccessApi instance
	/// @param[in] busType  The type of the underlying bus
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL DestroySignalAccessApi(VIAChannel channel, VIABusInterfaceType busType) = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 141)
	// GetUserFilePath returns the full path to a CANoe 'User File'.
	// Return values
	//   kVIA_OK                the path was successfully written to pathBuffer.
	//   kVIA_ObjectNotFound    the given file name was not found in the list of configured user files (in distributed
	...
	//   kVIA_Failed            unspecific error
	// Supported by CAPL-on-Board: No
	VIASTDDECL GetUserFilePath2(const char* filename,   // [IN]   The filename of the user file (example: 'settings.ini')
		char* pathBuffer,       // [OUT]  The full path of the user file is copied to this buffer
		int32 pathBufferLength, // [IN]   size of parameter pathBuffer
		uint32 codepage) = 0;   // [IN]   Current code page
#endif
}; // class VIAService
...
// This class must be implemented by a Nodelayer-DLL.
//
...
#endif
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 147)
	// Is called BEFORE the CAPL Event Handler'on onStart' is triggered but timer can be used
	VIASTDDECL PreStartMeasurement() = 0;
#endif
};

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 140)
/// @brief Interface an application, which is called by the runtime kernel.
///        This class must be implemented by an ApplicationModel-DLL.
class VIAApplication
{
public:
	...
	/// @brief Retrieves the version of the VIAApplication as string
	/// @param[in,out] buffer  The buffer to write the string to
	/// @param[in] bufferLength  The size of the buffer
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL GetVersion(char* buffer, int32 bufferLength) = 0;

	/// @brief Callback handling the initialization step before the CAPL 'on preStart' step
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL PreInitMeasurement() = 0;

	/// @brief Callback handling the initialization step of the measurement
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL InitMeasurement() = 0;

	/// @brief Callback for init complete notifications
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL InitMeasurementComplete() = 0;

	/// @brief Callback handling the measurement start step
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL StartMeasurement() = 0;

	/// @brief Callback handling the pre stop step
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL PreStopMeasurement() = 0;

	/// @brief Callback handling the stop measurement step
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL StopMeasurement() = 0;

	/// @brief Callback handling the end measurement step
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL EndMeasurement() = 0;
};
#endif
...
public:
	...
	VIASTDDECL GetModuleParameters(char* pathBuff, int32 pathBuffLength, char* versionBuff, int32 versionBuffLength) = 0;
	...
	VIASTDDECL GetNodeInfo(const char* nodename, // name of the node
		char* shortNameBuf,
		int32 shortBufLength,
		char* longNameBuf,
		int32 longBufLength) = 0;
	...
	VIASTDDECL CreateObject(VIANodeLayerApi** object, // [OUT] The created instance
		...
		int32 argc,
		char* argv[]) = 0; // [IN] Additional parameters
...
public:
	...
	VIASTDDECL GetOEMBackendResponseInterfaceVersion(uint16* oemBackendResponseApiVersion) = 0; // Implement always a
	// simple function that
	// returns the enum
	// eOEMBackendApiVersion
...
// responseDataLength: The response length
	VIASTDDECL OnOEMBackendResponse(const char* requestHandlerId,
		uint32 requestHandlerIdLength,
		const char* requestParameter,
		uint32 requestParameterLength,
		const uint8* responseData,
...
//
// class VIASecurity
// Provides access to security profiles.
//
class VIASecurity
{
public:
	VIASTDDECL Release() = 0;
	// Gets the profile instance configuration for a given profile ID
	VIASTDDECL GetSecurityProfile(const char* id, char* buffer, uint32& bufferLength) = 0;
	VIASTDDECL GetSecurityProfileLength(const char* id, uint32& bufferLength) = 0;
};
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 139)
/// @brief Physical address of the SharedMemory Page
using VIAMemoryAddress = uint8*;

/// @brief Callback for notifications about completed pages
struct VIASharedMemoryPageReadyHandler
{
	/// @brief Indicates that the SharedMemorPage is ready and can be read
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL OnSharedMemoryPageReady() = 0;
};

/// @brief Callback for scheduler status updates
struct VIASchedulerStatusUpdateHandler
{
	/// @brief Notifies about a scheduler status update
	/// @param[in] numEnqueuedTasks  the number of currently enqueued tasks
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL OnSchedulerStatusUpdate(int32 numEnqueuedTasks) = 0;
};

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 145)
/// @brief Callback for thew worker finished completed handler
struct VIAWorkerFinishedCompletedHandler
{
	/// @brief Notifies that the scheduler completed the OnWorkerFinished method.
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL OnWorkerFinishedCompleted() = 0;
};
#endif

/// @brief Denotes the exchanged datatype
enum class VIASharedMemoryDataExchangeType
{
	eUndefined = 0,
	eInt8 = 1,
	eInt16 = 2,
...
/// @brief Denotes the level at which data is exchanged
enum class VIASharedMemoryDataExchangeTypeLevel
{
	eRaw = 0,
	ePhys = 1,
	eImpl = 2
...
/// @brief Denotes the type of the DO member
enum class VIASharedMemoryDOMemberType
{
	eUndefined = 0,
	eSignalValue = 1,
	eLatestCallValue = 2,
	eLatestCallRequestId = 3,
	eLatestReturnValue = 4,
	eLatestReturnRequestId = 5,
	eLatestReturnResult = 6,
	eFunctionCallValue = 7,
	eFunctionCallTrigger = 8,
	eFunctionCallRequestId = 9,
	eFunctionAnswerOut = 10,
	eFunctionAnswerResult = 11,
	eFunctionAnswerServerSimulatorMode = 12,
	eFunctionAnswerReturnDelay = 13,
	eDataValue = 14,
	eEventValue = 15
};

/// @brief Denotes the type of a union element
enum class VIASharedMemoryUnionElementType
{
	// enum values must be equivalent to the values defined in `FbBusScriptCreator.h`
	eNonUnionElement = 1,
	eIndexerForExplicitDiscriminator = 2,
	eIndexerForImplicitDiscriminator = 3,
	eUnionRootElement = 4,
	eUnionSubElement = 5
};

/// @brief SharedMemoryPage implementation used to exchange simulation data between the RTK and a VIA client
class VIASharedMemoryPage
{
public:
	// -- Page configuration ----------------------------------------------------

	/// @brief Sets the base update interval of the scheduler.
	/// @param[in] updateIntervalNS The update interval of the SharedMemoryPage in nanoseconds
	/// @param[in] firstUpdateAtT0 Whether the first update is done at t=0
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL SetSchedulerUpdateInterval(VIATime updateIntervalNS, bool firstUpdateAtT0) = 0;

	/// @brief Sets the oversampling rate of the scheduler.
	/// @param[in] oversamplingRate  The oversampling rate of the SharedMemoryPage
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL SetSchedulerOversamplingRate(uint32 oversamplingRate) = 0;

	/// @brief Adds a signal value to the page
	/// @param[in] name  the unique name of the signal value
	/// @param[in] enforceRawValue  Whether to enforce raw value usage
	/// @param[out] dataExchangeType  The data type of the signal data
	/// @param[out] offset  the memory offset within the shared memory page.
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL AddSignal(const char* name,
		bool enforceRawValue,
		VIASharedMemoryDataExchangeType& dataExchangeType,
		uint32& offset) = 0;

	/// @brief Adds a system variable value element to the shared memory
	/// @param[in] path  The path of the system variable element (sysVar, sysVarStruct, sysVarMember etc...)
	/// @param[in] enforceRawValue  Whether to enforce raw value usage
	/// @param[out] dataExchangeType  The data type of the exchanged data
	/// @param[out] dataExchangeSize  Size of the exchanged data
	/// @param[out] offset  the memory offset within the shared memory page.
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL AddSysVarValueElement(const char* path,
		bool enforceRawValue,
		VIASharedMemoryDataExchangeType& dataExchangeType,
		uint32& dataExchangeSize,
		uint32& offset) = 0;

	/// @brief Adds a system variable value element array to the shared memory
	/// @param[in] path  The path of the system variable element array (sysVar, sysVarMember etc...)
	/// @param[in] nrOfValues  Number of values in the array
	/// @param[in] enforceRawValue  Whether to enforce raw value usage
	/// @param[out] dataExchangeElementType  The data type of the exchanged data per element
	/// @param[out] dataExchangeElementSize  Size of the exchanged data per element
	/// @param[out] offset  the memory offset within the shared memory page.
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL AddSysVarValueElementArray(const char* path,
		uint32 nrOfValues,
		bool enforceRawValue,
		VIASharedMemoryDataExchangeType& dataExchangeElementType,
		uint32& dataExchangeElementSize,
		uint32& offset) = 0;

	/// Adds a scalar DO value element to the shared memory page.
	/// @param[in] memberPath  path of the DO member
	/// @param[in] elementPath  path of the element within the DO member if only a single struct element should be
	/// exchanged, empty string otherwise
	/// @param[in] memberType  type of the element to exchange
	/// @param[in] dataExchangeTypeLevel  whether the raw, phys, or impl value should be exchanged
	/// @param[in] unionElementType  whether this is a non-union element, an element of a union, or the indexer of a union
	/// @param[in] unionDiscriminatorIndexerPath  if this is a union element, the member path to the corresponding
	/// indexer, empty string otherwise
	/// @param[in] unionDiscriminatorExpectedValue  if this is a union element, the union indexer value for which this
	/// element is valid, -1 otherwise
	/// @param[out] dataExchangeType  the data type used for data exchange
	/// @param[out] offset  the memory offset within the shared memory page.
	VIASTDDECL AddDOValueScalarValue(const char* memberPath,
		const char* elementPath,
		VIASharedMemoryDOMemberType memberType,
		VIASharedMemoryDataExchangeTypeLevel dataExchangeTypeLevel,
		VIASharedMemoryUnionElementType unionElementType,
		const char* unionDiscriminatorIndexerPath,
		int32 unionDiscriminatorExpectedValue,
		VIASharedMemoryDataExchangeType& dataExchangeType,
		uint32& offset) = 0;

	/// Adds a DO value element which is an array of scalar values to the shared memory page.
	/// @param[in] memberPath  path of the DO member
	/// @param[in] elementPath  path of the element within the DO member if only a single struct element should be
	/// exchanged, empty string otherwise
	/// @param[in] memberType  type of the element to exchange
	...
	/// @param[in] unionDiscriminatorExpectedValue  if this is a union element, the union indexer value for which this
	/// element is valid, -1 otherwise
	/// @param[out] dataExchangeType  the data type used for data exchange for each single array element
	/// @param[out] offset  the memory offset within the shared memory page.
	VIASTDDECL AddDOValueScalarArrayValue(const char* memberPath,
		const char* elementPath,
		VIASharedMemoryDOMemberType memberType,
		uint32 arraySize,
		VIASharedMemoryDataExchangeTypeLevel dataExchangeTypeLevel,
	...
	/// @brief Returns the memory address of the shared memory page. Returns nullptr if the page is an inter-process
	/// page, or if the page is not yet finalized (called before measurement start)
	/// @param[out] address  the memory address of the shared memory page or nullptr in the stated cases
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL GetMemoryAddress(VIAMemoryAddress& address) = 0;

	// -- Notification Functions ------------------------------------------------

	/// @brief Registers a handler for notifications for when the shared-memory page has been written to by CANoe
	/// @param[in] handler  pointer to the handler that should be registered
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL RegisterSharedMemoryPageReadyHandler(VIASharedMemoryPageReadyHandler* handler) = 0;

	/// @brief Notifies CANoe that the worker has finished the task. This function may be called from a BG thread
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL WorkerFinished() = 0;

	/// @brief Registers a handler for scheduler status updates
	/// @param[in] handler  a pointer to the handler that should be registered
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL RegisterSchedulerStatusUpdateHandler(VIASchedulerStatusUpdateHandler* handler) = 0;

	// -- Further functions, added after the last release (new functions must always be added at the end) --

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 144)
/// @brief Disables the timer of the scheduler.
/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL DisableSchedulerTimer() = 0;

	/// @brief Calls the trigger function of the underlying shared memory page.
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL Trigger() = 0;
#endif

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 145)
	/// @brief Registers a handler that is called by the scheduler on the main thread when the worker finished callback
	///        is completed
	/// @param[in] handler  a pointer to the handler that should be registered
	/// @returns a VIAResult denoting whether the call succeeded or not
	VIASTDDECL RegisterWorkerFinishedCompletedHandler(VIAWorkerFinishedCompletedHandler* handler) = 0;
#endif
};
#endif
...
#if defined(VIAMinorVersion) && (VIAMinorVersion >= 140)
/// @brief Creates a VIAApplication instance
/// @returns a pointer to the VIAApplication instance or nullptr in case of errors
VIACLIENT(VIAApplication*) VIAGetApplication();

/// @brief Releases a previously created VIAApplication instance
/// @param[in] application  The VIAApplication instance to release
VIACLIENT(void) VIAReleaseApplication(VIAApplication* application);
#endif
...
enum VGetModuleOptionsParameter
{
	...
	kVIA_GetModuleOption_SupportsFreeware = 3,
	kVIA_GetModuleOption_InterfaceType = 4,
};

// return codes for option Load
enum VGetModuleOptions_LoadOptions
{
	// default setting if option is unknown to the DLL (compatible to Permanent)
	kVIA_ModuleOption_LoadOption_Default = 0,
	// permanently load the DLL beyond measurement execution
	kVIA_ModuleOption_LoadOption_Permanent = 1,
	// defer load the DLL only during measurement execution
...
#endif
{
	// default setting if option is unknown to the DLL (compatible to StandardNodeLayer)
	kVIA_ModuleOption_DLLType_Default = 0,
	// standard node layer integrated in simulation or communication setup
	kVIA_ModuleOption_DLLType_StandardNodeLayer = 1,
	// C-Library client integrated through global options
	kVIA_ModuleOption_DLLType_CLibrary = 2,
	// Anlyz local node layer integrated in measurement setup
	kVIA_ModuleOption_DLLType_AnlyzNodelayer = 3,
	// System internal DO binding block implementation
	kVIA_ModuleOption_DLLType_DOBindingBlock = 4,
};

#if defined(VIAMinorVersion) && (VIAMinorVersion >= 140)
// return codes for option InterfaceType
enum VGetModuleOptions_InterfaceTypeOptions : int32
{
	// default setting if option is unknown to the DLL (compatible to ModuleApi)
	kVIA_ModuleOption_InterfaceType_Default = 0,
	// the DLL implements a network node specific module API
	kVIA_ModuleOption_InterfaceType_ModuleApi = 1,
	// the DLL implements a network independent application model
	kVIA_ModuleOption_InterfaceType_ApplicationModel = 2,
};
#endif
...
{
	// default setting if option is unknown to the DLL (compatible to NotSupported)
	kVIA_ModuleOption_CAPLonBoard_Default = 0,
	// the implementation supports CAPL on board
	kVIA_ModuleOption_CAPLonBoard_Supported = 1,
	// the implementation does not support CAPL on board
	kVIA_ModuleOption_CAPLonBoard_NotSupported = -1,
};

// return codes for option Freeware (e.g. Vector Test Unit Runner)
enum VGetModuleOption_FreewareOption
{
	// default setting if option is unknown to the DLL (compatible to NotSupported)
	kVIA_ModuleOption_Freeware_Default = 0,
	// the implementation can be used with freeware products
	kVIA_ModuleOption_Freeware_Supported = 1,
	// the implementation cannot be used with freeware products
	kVIA_ModuleOption_Freeware_NotSupported = 2,
};

// the implementation is called multiple times with different options from VGetModuleOptionsParameter
