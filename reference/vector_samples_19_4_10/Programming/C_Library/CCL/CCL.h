...
2.3  2021-12-08  Added bulk value update functions for DO values
2.4  2024-11-15  Added application model handling
2.5  2025-07-22  Fix cleanup of Ethernet bus context at end of measurement
                 Remove some compiler warnings
                 Missing entires in module definition file for Windows-x86 added.
==================================================================================================================== */
#pragma once
...
#define CCL_NODELAYER_UNDEFINED           ((int32_t) -94)
...
extern void cclSetInterfaceType(cclInterfaceType ifType);
