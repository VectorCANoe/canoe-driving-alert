...
extern void OnSysVar_a(int64_t time, int32_t sysVarID);
...
{
  int32_t rc;
  int32_t d[5] = { 5, 4, 3, 2, 1 };
  double e[5] = { 5.5, 4.4 ,3.3, 2.2, 1.1 };
  uint8_t f[6] = { 6, 5, 4, 3, 2, 1 };
...
void OnSysVar_a(int64_t time, int32_t sysVarID)
{
