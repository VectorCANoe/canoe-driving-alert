...
namespace COM_Csharp_CANoe_Demo
{
    public partial class Form_Csharp_CANoe : Form
    {
        ...
        private void CANoeQuit()
        {
            ...
            // Reinitialize the Form & Pay attention to thread safety, as the accessed controls were created in the GUI thread!
            DelSafeInvocation safeinvocation_reinitialize = new DelSafeInvocation(ReinitializeForm);
            this.Invoke(safeinvocation_reinitialize);
        }
        ...
        /// <summary>
        /// Used for thread safe call to reinitialize Form when CANoe has quit.
        /// <summary>
