...
namespace XILAPIServer
{
  public class Testbench : ITestbench
  {
    ...
    private readonly IMAPortFactory mMaPortFactory = new MAPortFactory();
    private readonly IValueFactory mValueFactory = new ValueFactory();
    ...
    {
      get { return mMaPortFactory; }
    }

    public ITargetScriptFactory TargetScriptFactory { get; }
