...
public class PanelHelper : MeasurementScript
{
    ...
    {
        Internal.Panel.AverageTemperature.Value = (RoomTemperatureControl.Sensor1.Temperature.Value +
