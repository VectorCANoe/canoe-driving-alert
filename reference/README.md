...
- `standards/`
  - ASPICE, ISO 26262, AUTOSAR, and sample document references
- `dbc/`
  - external/reference DBC material
- `vector_samples_19_4_10/`
  - Vector sample assets kept for study and comparison
- `catalogs/`
  - internal reference catalogs
- `cli_bp/`
  - CLI best-practice intake references
