<<<<<<<< HEAD:canoe/docs/20_VERIFICATION/22_TEAM_EXECUTION_FLOW.md
# Team Execution Flow
========
﻿# Team Execution Flow
>>>>>>>> cleanup/remove-legacy-assets-20260313:canoe/docs/verification/22_TEAM_EXECUTION_FLOW.md
...
========
- owns the SSoT chain under `driving-alert-workproducts/`
>>>>>>>> cleanup/remove-legacy-assets-20260313:canoe/docs/verification/22_TEAM_EXECUTION_FLOW.md
...
5. Docs updates:
   ...
   - `07_System_Test.md`
   - `ops/handoff/TMP_HANDOFF.md` if the active next-step picture changes
6. Docs refreshes the submission package from root SSoT `driving-alert-workproducts/` and `driving-alert-workproducts/excel/`.
