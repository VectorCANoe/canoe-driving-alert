...
| Seam | Logical owner | Primary consumer | 의도 |
| --- | --- | --- | --- |
| `ethSelectedAlertMsg` | `ADAS` | `BCM`, `IVI`, downstream warning consumer | selected alert result |
...
- 일부 downstream consumer는 fresh backbone result seam이 없을 때 `Core::*` mirror로 fallback할 수 있습니다.
