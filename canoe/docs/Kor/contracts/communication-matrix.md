...
동기화 기준:
- `5d83ee7f`
- message name, ECU name, DBC 이름, backbone source 값은 canonical technical identifier로 유지합니다.

> [!IMPORTANT]
> 이 문서는 현재 개발 baseline과 계획 중인 target architecture를 반영합니다.
> runtime, diagnostic, verification 세부사항 가운데 일부는 아직 구현 중이며 변경될 수 있습니다.

- 생성 시각: 2026-03-12 23:58:00
- 범위: domain CAN과 Ethernet backbone contract에 대한 active runtime ownership
- 규칙: active runtime profile에서 각 message는 명확한 sender 1개를 가져야 합니다.
