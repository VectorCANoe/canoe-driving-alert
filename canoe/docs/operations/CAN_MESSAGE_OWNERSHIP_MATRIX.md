...
|---|---|---|---|---|---|
| frmVehicleStateCanMsg | 0x100 | 2 | VAL_SCENARIO_CTRL | chassis_can.dbc | 3 |
| frmSteeringCanMsg | 0x101 | 1 | VAL_SCENARIO_CTRL | chassis_can.dbc | 2 |
| frmPedalInputCanMsg | 0x102 | 2 | VAL_SCENARIO_CTRL | chassis_can.dbc | 2 |
| frmSteeringStateCanMsg | 0x103 | 1 | CHS_GW | chassis_can.dbc | 2 |
| frmWheelSpeedMsg | 0x104 | 4 | CHS_GW | chassis_can.dbc | 4 |
| frmYawAccelMsg | 0x105 | 4 | CHS_GW | chassis_can.dbc | 2 |
| frmBrakeStatusMsg | 0x106 | 2 | BRK_CTRL | chassis_can.dbc | 5 |
| frmAccelStatusMsg | 0x107 | 2 | ACCEL_CTRL | chassis_can.dbc | 2 |
| frmSteeringTorqueMsg | 0x108 | 2 | STEER_CTRL | chassis_can.dbc | 2 |
| frmChassisHealthMsg | 0x109 | 2 | CHS_GW | chassis_can.dbc | 3 |
| frmEpsStateMsg | 0x10A | 2 | STEER_CTRL | chassis_can.dbc | 4 |
| frmAbsStateMsg | 0x10B | 2 | BRK_CTRL | chassis_can.dbc | 3 |
| frmEscStateMsg | 0x10C | 2 | BRK_CTRL | chassis_can.dbc | 3 |
| frmTcsStateMsg | 0x10D | 2 | ACCEL_CTRL | chassis_can.dbc | 3 |
| frmBrakeTempMsg | 0x10E | 2 | BRK_CTRL | chassis_can.dbc | 2 |
| frmSteeringAngleMsg | 0x10F | 2 | STEER_CTRL | chassis_can.dbc | 1 |
| frmNavContextCanMsg | 0x110 | 3 | VAL_SCENARIO_CTRL | infotainment_can.dbc | 5 |
| frmWheelPulseMsg | 0x11A | 2 | CHS_GW | chassis_can.dbc | 2 |
| frmSuspensionStateMsg | 0x11B | 2 | CHS_GW | chassis_can.dbc | 3 |
| frmTirePressureMsg | 0x11C | 4 | CHS_GW | chassis_can.dbc | 4 |
| frmChassisDiagReqMsg | 0x11D | 3 | VAL_SCENARIO_CTRL | chassis_can.dbc | 3 |
| frmChassisDiagResMsg | 0x11E | 3 | CHS_GW | chassis_can.dbc | 3 |
| frmAdasChassisStatusMsg | 0x11F | 2 | ADAS_WARN_CTRL | chassis_can.dbc | 2 |
| frmBrakeWearMsg | 0x120 | 1 | BRK_CTRL | chassis_can.dbc | 1 |
| frmRoadFrictionMsg | 0x121 | 1 | CHS_GW | chassis_can.dbc | 1 |
...
| frmTestResultMsg | 0x230 | 1 | VAL_SCENARIO_CTRL | chassis_can.dbc | 2 |
| frmBaseTestResultMsg | 0x231 | 8 | VAL_BASELINE_CTRL | chassis_can.dbc | 6 |
...
| frmBcmDiagResMsg | 0x249 | 3 | AMBIENT_CTRL | body_can.dbc | 3 |
...
| frmIviDiagReqMsg | 0x267 | 3 | VAL_SCENARIO_CTRL | infotainment_can.dbc | 3 |
...
| frmIgnitionEngineMsg | 0x300 | 1 | VAL_SCENARIO_CTRL | powertrain_can.dbc | 3 |
| frmGearStateMsg | 0x301 | 1 | VAL_SCENARIO_CTRL | powertrain_can.dbc | 3 |
| frmPowertrainGatewayMsg | 0x302 | 2 | DOMAIN_ROUTER | powertrain_can.dbc | 2 |
| frmEngineSpeedTempMsg | 0x303 | 4 | ENG_CTRL | powertrain_can.dbc | 3 |
| frmFuelBatteryStateMsg | 0x304 | 3 | ENG_CTRL | powertrain_can.dbc | 4 |
| frmThrottleStateMsg | 0x305 | 2 | ENG_CTRL | powertrain_can.dbc | 2 |
| frmTransmissionTempMsg | 0x306 | 2 | TCM | powertrain_can.dbc | 2 |
| frmVehicleModeMsg | 0x307 | 2 | DOMAIN_ROUTER | powertrain_can.dbc | 6 |
| frmPowerLimitMsg | 0x308 | 2 | DOMAIN_ROUTER | powertrain_can.dbc | 2 |
| frmCruiseStateMsg | 0x309 | 2 | DOMAIN_ROUTER | powertrain_can.dbc | 4 |
| frmPowertrainHealthMsg | 0x30A | 2 | DOMAIN_ROUTER | powertrain_can.dbc | 3 |
| frmEngineTorqueMsg | 0x30B | 2 | ENG_CTRL | powertrain_can.dbc | 1 |
| frmEngineLoadMsg | 0x30C | 1 | ENG_CTRL | powertrain_can.dbc | 1 |
| frmTransShiftStateMsg | 0x30D | 2 | TCM | powertrain_can.dbc | 4 |
| frmPtDiagReqMsg | 0x30E | 3 | VAL_SCENARIO_CTRL | powertrain_can.dbc | 3 |
| frmPtDiagResMsg | 0x30F | 3 | DOMAIN_ROUTER | powertrain_can.dbc | 3 |
| frmThermalMgmtStateMsg | 0x310 | 2 | ENG_CTRL | powertrain_can.dbc | 3 |
| frmEnergyFlowStateMsg | 0x311 | 2 | DOMAIN_ROUTER | powertrain_can.dbc | 3 |
| frmPowertrainCtrlAuthMsg | 0x312 | 1 | DOMAIN_ROUTER | powertrain_can.dbc | 3 |
