...
- `frmEmergencyBroadcastMsg (0x1C0)` is a SIL stub exception.
  ...
  - Active implementation producers are `V2X` and `V2X`.
...
|---|---|---|---|---|---|
| frmSteeringStateCanMsg | 0x100 | 1 | CHGW | chassis_can.dbc | 2 |
| frmWheelSpeedMsg | 0x101 | 4 | CHGW | chassis_can.dbc | 4 |
| frmYawAccelMsg | 0x102 | 4 | CHGW | chassis_can.dbc | 2 |
| frmChassisHealthMsg | 0x103 | 2 | CHGW | chassis_can.dbc | 3 |
| frmWheelPulseMsg | 0x104 | 2 | CHGW | chassis_can.dbc | 2 |
| frmSuspensionStateMsg | 0x105 | 2 | CHGW | chassis_can.dbc | 3 |
| frmTirePressureMsg | 0x106 | 4 | CHGW | chassis_can.dbc | 4 |
| frmChassisDiagResMsg | 0x107 | 3 | CHGW | chassis_can.dbc | 3 |
| frmRoadFrictionMsg | 0x108 | 1 | CHGW | chassis_can.dbc | 1 |
| frmPowertrainGatewayMsg | 0x109 | 2 | PTGW | powertrain_can.dbc | 2 |
| frmVehicleModeMsg | 0x10A | 2 | PTGW | powertrain_can.dbc | 6 |
| frmPowerLimitMsg | 0x10B | 2 | PTGW | powertrain_can.dbc | 2 |
| frmCruiseStateMsg | 0x10C | 2 | PTGW | powertrain_can.dbc | 4 |
| frmPowertrainHealthMsg | 0x10D | 2 | PTGW | powertrain_can.dbc | 3 |
| frmPtDiagResMsg | 0x10E | 3 | PTGW | powertrain_can.dbc | 3 |
| frmEnergyFlowStateMsg | 0x10F | 2 | PTGW | powertrain_can.dbc | 3 |
| frmPowertrainCtrlAuthMsg | 0x110 | 1 | PTGW | powertrain_can.dbc | 3 |
...
| frmAbsStateMsg | 0x124 | 2 | ESC | chassis_can.dbc | 3 |
...
| frmSteeringAngleMsg | 0x128 | 2 | MDPS | chassis_can.dbc | 1 |
...
| frmWiperStateMsg | 0x266 | 1 | BCM | body_can.dbc | 3 |
...
| frmHvacStateMsg | 0x26A | 2 | BCM | body_can.dbc | 4 |
| frmHvacActuatorMsg | 0x26B | 2 | BCM | body_can.dbc | 5 |
| frmMirrorStateMsg | 0x26C | 1 | BCM | body_can.dbc | 4 |
...
| frmImmobilizerStateMsg | 0x274 | 1 | BCM | body_can.dbc | 3 |
| frmAlarmStateMsg | 0x275 | 1 | BCM | body_can.dbc | 3 |
...
| frmNaviGuideStateMsg | 0x282 | 1 | IVI | infotainment_can.dbc | 2 |
| frmMediaStateMsg | 0x283 | 2 | IVI | infotainment_can.dbc | 5 |
| frmCallStateMsg | 0x284 | 2 | IVI | infotainment_can.dbc | 5 |
| frmNavigationRouteMsg | 0x285 | 3 | IVI | infotainment_can.dbc | 5 |
...
| frmVoiceAssistStateMsg | 0x28A | 1 | IVI | infotainment_can.dbc | 3 |
| frmMapRenderStateMsg | 0x28B | 2 | IVI | infotainment_can.dbc | 3 |
| frmRouteAlertMsg | 0x28C | 2 | IVI | infotainment_can.dbc | 4 |
| frmTrafficEventMsg | 0x28D | 3 | IVI | infotainment_can.dbc | 3 |
...
| frmSpeechTtsStateMsg | 0x292 | 2 | IVI | infotainment_can.dbc | 4 |
...
| ethVehicleStateMsg | 0x510 | 2 | CHGW | eth_backbone_can_stub.dbc | 3 |
| ethSteeringMsg | 0x511 | 1 | CHGW | eth_backbone_can_stub.dbc | 2 |
| ethNavContextMsg | 0x512 | 3 | IVI | eth_backbone_can_stub.dbc | 5 |
