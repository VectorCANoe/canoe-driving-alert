...
|---|---|---|---|---|---|---|---|---|---|
| ethVehicleStateMsg | 0x510 | 2 | vehicleSpeed | 0~7 | 0~255 | CHGW | ADAS | 100ms | Chassis CAN(0x2A0) 정규화 |
|  |  |  | driveState | 8~9 | 0~3 | CHGW | ADAS | 100ms | 0:P,1:R,2:N,3:D |
| ethSteeringMsg | 0x511 | 1 | steeringInput | 0 | 0~1 | CHGW | ADAS | 100ms | Chassis CAN(0x2A1) 정규화 |
| ethNavContextMsg | 0x512 | 3 | roadZone | 0~1 | 0~3 | IVI | IVI, ADAS, ADAS | 100ms | Infotainment CAN(0x2A3) 정규화 |
|  |  |  | navDirection | 2~3 | 0~3 | IVI | IVI, ADAS, ADAS | 100ms | 0:None,1:Left,2:Right,3:Other |
|  |  |  | zoneDistance | 8~15 | 0~255 | IVI | IVI, ADAS, ADAS | 100ms | m |
|  |  |  | speedLimit | 16~23 | 0~255 | IVI | IVI, ADAS, ADAS | 100ms | km/h |
| ETH_EmergencyAlert | 0xE100 | 4 | emergencyType | 0~1 | 0~3 | V2X, V2X | V2X | 100ms | 0:None,1:Police,2:Ambulance |
|  |  |  | emergencyDirection | 2~3 | 0~3 | V2X, V2X | V2X | 100ms | 0:Front,1:Left,2:Right,3:Rear |
|  |  |  | eta | 8~15 | 0~255 | V2X, V2X | V2X | 100ms | s |
|  |  |  | sourceId | 16~23 | 0~255 | V2X, V2X | V2X | 100ms | 동률 판단 보조 |
|  |  |  | alertState | 24 | 0~1 | V2X, V2X | V2X | 100ms | 0:Clear,1:Active |
...
| ethDecelAssistReqMsg | 0x1C4(SIL Stub) / 0xE211(Logical) | 4 | decelAssistReq | 0 | 0~1 | ADAS | CHGW, ESC, VAL_SCENARIO_CTRL | Event + 50ms | V2 감속보조 요청 |
|  |  |  | failSafeMode | 1~2 | 0~2 | ADAS | CHGW, ESC, VAL_SCENARIO_CTRL | Event + 50ms | 0:Normal,1:Degraded,2:Blocked |
|  |  |  | driverReleaseReason | 3~4 | 0~3 | ADAS | CHGW, ESC, VAL_SCENARIO_CTRL | Event + 50ms | 0:None,1:Steer,2:Brake,3:FailSafe |
|  |  |  | emergencyContext | 5~6 | 0~2 | ADAS | CHGW, ESC, VAL_SCENARIO_CTRL | Event + 50ms | 긴급 컨텍스트 |
|  |  |  | proximityRiskLevel | 8~15 | 0~100 | ADAS | CHGW, ESC, VAL_SCENARIO_CTRL | Event + 50ms | 위험도 전달 |
