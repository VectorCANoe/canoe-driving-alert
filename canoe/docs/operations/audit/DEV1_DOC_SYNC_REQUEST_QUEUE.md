...
|---|---|---|---|---|---|
| DSR-001 | High | `0303_Communication_Specification.md` | `Comm_106` | Fix residual `frmBaseTestResultMsg` wording to match active chain: `TST_SCN -> frmTestResultMsg(0x2A5) -> TST_BAS -> frmBaseTestResultMsg(0x2A6)` | `DEV1_INTERFACE_AUDIT_REPORT_2026-03-08.md` |
