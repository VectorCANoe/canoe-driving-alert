...
- target: `12~18`
- chosen baseline (current): `58` (`56` product + `2` validation)
- note:
...
55. `DIGITAL_KEY`
56. `RSE`
57. `VALIDATION_HARNESS` (`VAL_SCENARIO_CTRL`)
58. `VALIDATION_HARNESS` (`VAL_BASELINE_CTRL`)
...
- Rule:
  ...
  - active deep implementation is currently `58`
