...
- target: `12~18`
- chosen baseline (current): `74` (`72` product + `2` validation)
- note:
...
72. `BIOMETRIC_AUTH`
73. `VALIDATION_HARNESS` (`VAL_SCENARIO_CTRL`)
74. `VALIDATION_HARNESS` (`VAL_BASELINE_CTRL`)
...
- Rule:
  ...
  - active deep implementation is currently `74`
