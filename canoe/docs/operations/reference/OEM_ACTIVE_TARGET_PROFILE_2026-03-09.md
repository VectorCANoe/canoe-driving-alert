...
- target: `12~18`
- chosen baseline (current): `50` (`48` product + `2` validation)
- note:
...
47. `SRR_FR`
48. `PARK_ULTRASONIC`
49. `VALIDATION_HARNESS` (`VAL_SCENARIO_CTRL`)
50. `VALIDATION_HARNESS` (`VAL_BASELINE_CTRL`)
...
- Rule:
  ...
  - active deep implementation is currently `50`
