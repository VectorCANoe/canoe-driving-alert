...
- target: `12~18`
- chosen baseline (current): `54` (`52` product + `2` validation)
- note:
...
51. `SRR_RL`
52. `SRR_RR`
53. `VALIDATION_HARNESS` (`VAL_SCENARIO_CTRL`)
54. `VALIDATION_HARNESS` (`VAL_BASELINE_CTRL`)
...
- Rule:
  ...
  - active deep implementation is currently `54`
