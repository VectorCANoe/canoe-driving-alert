...
- target: `12~18`
- chosen baseline (current): `70` (`68` product + `2` validation)
- note:
...
67. `MCU`
68. `INVERTER`
69. `VALIDATION_HARNESS` (`VAL_SCENARIO_CTRL`)
70. `VALIDATION_HARNESS` (`VAL_BASELINE_CTRL`)
...
- Rule:
  ...
  - active deep implementation is currently `70`
