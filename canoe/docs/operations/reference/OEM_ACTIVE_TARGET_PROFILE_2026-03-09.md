...
- target: `12~18`
- chosen baseline (current): `26` (`24` product + `2` validation)
- note:
...
23. `TPMS`
24. `SAS`
25. `VALIDATION_HARNESS` (`VAL_SCENARIO_CTRL`)
26. `VALIDATION_HARNESS` (`VAL_BASELINE_CTRL`)
...
- Rule:
  ...
  - active deep implementation is currently `26`
