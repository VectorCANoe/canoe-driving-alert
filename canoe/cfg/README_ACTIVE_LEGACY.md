...
- `v1_cfg/CAN_500kBaud_1ch.cfg`
- `v1_cfg/CAN_500kBaud_1ch.cfg.ini`
- `v1_cfg/CAN_500kBaud_1ch.stcfg`
...
2. Do not select files under `cfg/v1_cfg` unless explicitly requested.
