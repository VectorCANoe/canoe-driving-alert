...
NODE_COMMENTS = {
    ...
    "BCM_AMBIENT_CTRL": "Ambient controller ECU (consumer of 0x210).",
    "CLU_HMI_CTRL": "Cluster HMI ECU (consumer of 0x220).",
    "ACCEL_CTRL": "Baseline vehicle function node for acceleration input handling.",
    "BRAKE_CTRL": "Baseline vehicle function node for brake input handling.",
    ...
    "NAV_CONTEXT_MGR": "Navigation context manager node.",
    "CLUSTER_BASE_CTRL": "Cluster baseline display manager node.",
    "DOMAIN_GW_ROUTER": "Domain gateway router for inter-domain frame routing policy.",
...
def main() -> int:
    ...
    split_plan = {
        ...
        "emergency_system_body.dbc": {
            ...
            "ids": [0x210],
            "extra_nodes": ["HAZARD_CTRL", "WINDOW_CTRL", "DRIVER_STATE_CTRL", "WARN_ARB_MGR"],
        ...
        "emergency_system_infotainment.dbc": {
            ...
            "ids": [0x110, 0x220],
            "extra_nodes": ["NAV_CONTEXT_MGR", "CLUSTER_BASE_CTRL"],
