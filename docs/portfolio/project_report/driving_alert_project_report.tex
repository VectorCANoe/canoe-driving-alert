...
\FigureImage{프로젝트 한 줄 개요도}{58mm}{../../planning_and_Blog/final_screenshot/image copy 80.png}

\FigureImage{대표 시나리오 개요}{58mm}{../../planning_and_Blog/final_screenshot/image copy 81.png}
...
\FigureImage{이슈 및 일정 관리 흐름}{52mm}{../../planning_and_Blog/final_screenshot/image copy 65.png}
...
\FigureImage{회의 기록 및 지식 공유}{52mm}{../../planning_and_Blog/final_screenshot/image copy 66.png}
...
\FigureImage{문서 및 추적 체계 개요}{56mm}{../../planning_and_Blog/final_screenshot/image copy 72.png}

\subsection{프로젝트 자산 구성도}
\FigureImage{프로젝트 자산 구성도}{72mm}{../../planning_and_Blog/final_screenshot/image copy 69.png}
...
\FigureImage{안전 및 검증 요구 연계 개요}{56mm}{../../../driving-alert-workproducts/governance/short-paper/ppt/assets/asset_12_hara_test_matrix_bridge.png}
...
\FigureImage{요구사항 및 컨셉 요약}{58mm}{../../planning_and_Blog/final_screenshot/image copy 71.png}
...
\FigureImage{컨셉 아키텍처 구성도}{72mm}{../../planning_and_Blog/final_screenshot/image copy 69.png}

\FigureImage{전체 차량 ECU 기준선 구조}{65mm}{../../planning_and_Blog/final_screenshot/image copy 82.png}
...
\FigureImage{네트워크 흐름 설계도}{65mm}{../../../driving-alert-workproducts/governance/short-paper/ppt/assets/asset_16_network_message_flow.png}
...
\FigureImage{ECU 그룹 간 동작 시퀀스 개요}{58mm}{../../planning_and_Blog/final_screenshot/image copy 63.png}
...
\FigureImage{CAN DB 설계 요약}{68mm}{generated/candb_design_summary.png}
...
\FigureImage{메시지 매트릭스 요약}{68mm}{generated/candb_message_signal_summary.png}
...
\FigureImage{전체 차량 기준선 ECU 그룹}{56mm}{generated/ecu_baseline_group_crop.png}

\FigureImage{기본 차량 기준선 시퀀스 플로우}{56mm}{../../planning_and_Blog/final_screenshot/image copy 61.png}
...
\FigureImage{입력 및 기준선 ECU 그룹 구조}{56mm}{../../planning_and_Blog/final_screenshot/image copy 80.png}
...
\FigureImage{V2X 정규화 구조}{58mm}{../../../driving-alert-workproducts/governance/short-paper/ppt/assets/asset_36_v2x_role_normalization.png}

\FigureImage{V2X 시퀀스 플로우}{58mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/V2X_PRIORITY_ARBITRATION_SIGNAL_FLOW_2026-03-28.png}
...
\FigureImage{ADAS 상태 함수 및 위험도 구조}{60mm}{../../../driving-alert-workproducts/governance/short-paper/ppt/assets/asset_24_adas_state_function.png}

\FigureImage{객체 위험도 / TTC / 중재 구조}{60mm}{../../../driving-alert-workproducts/governance/short-paper/ppt/assets/asset_30_object_risk_and_rt_selection.png}

\FigureImage{ADAS 시퀀스 플로우}{58mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/OBJECT_RISK_TO_WARNING_SIGNAL_FLOW_2026-03-28.png}
...
\FigureImage{CGW 및 진단·관측 계층 구조}{58mm}{../../../driving-alert-workproducts/governance/short-paper/ppt/assets/asset_23_diag_observability_layer.png}

\FigureImage{CGW 시퀀스 플로우}{58mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/FAILSAFE_ESCALATION_TO_OUTPUT_SIGNAL_FLOW_2026-03-28.png}
...
\FigureImage{진단 및 관측 ECU 그룹 구조}{58mm}{../../planning_and_Blog/final_screenshot/image copy 64.png}

\FigureImage{진단 및 관측 그룹 시퀀스 플로우}{58mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/NAV_ALERT_CONTEXT_TO_DCM_REQUEST_RESPONSE_OBSERVATION_SIGNAL_FLOW_2026-03-29.png}
...
\FigureImage{출력 패널 및 상태 확인 구조}{58mm}{generated/panel_state_overview.png}

\FigureImage{패널 시퀀스 플로우}{58mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/ROUTE_WARNING_TO_HMI_SIGNAL_FLOW_2026-03-28.png}

\subsubsection{대표 시나리오 실행 묶음}
프로젝트에서 중요한 실행 장면은 기본 주행 기준선, 긴급 접근 정규화, 객체 위험 산정, 최종 경고 보정, 출력과 관측 반영으로 나누어 정리하였다.

\FigureImage{대표 시나리오 실행 묶음}{60mm}{../../planning_and_Blog/final_screenshot/image copy 81.png}
...
\FigureImage{기본 주행 시나리오}{56mm}{../../planning_and_Blog/final_screenshot/image copy 61.png}
...
\FigureImage{긴급 접근 시나리오}{56mm}{../../planning_and_Blog/final_screenshot/image copy 83.png}
...
\FigureImage{객체 위험 및 통합 시나리오}{56mm}{../../planning_and_Blog/final_screenshot/image copy 63.png}
...
\FigureImage{비상 보호 및 복귀 시나리오}{56mm}{../../../driving-alert-workproducts/governance/short-paper/ppt/assets/asset_33_fail_safe_boundary_recovery.png}
...
\FigureImage{UT 자산 및 실행 화면}{64mm}{../../planning_and_Blog/final_screenshot/image copy 21.png}

\FigureImage{IT 자산 및 실행 화면}{58mm}{../../planning_and_Blog/final_screenshot/image copy 81.png}

\FigureImage{ST 자산 및 실행 화면}{58mm}{../../planning_and_Blog/final_screenshot/image copy 78.png}
...
\FigureImage{실행 증빙 장면}{60mm}{../../planning_and_Blog/final_screenshot/image copy 64.png}

\FigureImage{테스트 리포트 대표 판정 화면}{78mm}{generated/test_report_evidence_summary.png}
...
\FigureImage{프로젝트 성과 요약 카드}{58mm}{../../../driving-alert-workproducts/governance/short-paper/ppt/assets/asset_19_result_metric_cards.png}
...
\FigureImage{정량 지표 구조}{60mm}{../../../driving-alert-workproducts/governance/short-paper/ppt/assets/asset_22_quantitative_result_table.png}
...
\FigureImage{추가 기술 자산 예시}{78mm}{generated/test_report_evidence_summary.png}
...
\FigureImage{DBC 파일의 데이터 Tx/Rx 다이어그램}{56mm}{generated/candb_design_summary.png}

\FigureImage{도메인 아키텍처 기반 네트워크 흐름도}{56mm}{../../planning_and_Blog/final_screenshot/image copy 82.png}
...
\FigureImage{단위 테스트 슈트 실행 결과}{56mm}{../../planning_and_Blog/final_screenshot/image copy 21.png}
