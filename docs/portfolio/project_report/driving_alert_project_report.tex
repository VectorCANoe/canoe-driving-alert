...
\FigureImage{컨셉 아키텍처 구성도}{82mm}{../../planning_and_Blog/final_screenshot/image copy 71.png}

\FigureImage{파워트레인 및 섀시 ECU 노드 구성}{82mm}{../../planning_and_Blog/final_screenshot/image copy 83.png}
...
\FigureImage{실제 CANoe 네트워크 및 노드 구성}{82mm}{../../planning_and_Blog/final_screenshot/image copy 72.png}
...
\FigureImage{CAN DB 설계 요약}{108mm}{generated/candb_design_summary.png}
...
\FigureImage{메시지 매트릭스 요약}{108mm}{generated/candb_message_signal_summary.png}
...
\FigureImage{파워트레인 ECU 노드 구성}{76mm}{generated/node_powertrain_network.png}

\FigureImage{섀시 ECU 노드 구성}{76mm}{generated/node_chassis_network.png}
...
\FigureImage{입력 패널과 기준선 화면 구성}{74mm}{../../planning_and_Blog/final_screenshot/image copy 80.png}
...
\FigureImage{V2X 시퀀스 플로우}{84mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/V2X_PRIORITY_ARBITRATION_SIGNAL_FLOW_2026-03-28.png}
...
\FigureImage{객체 위험도 / TTC / 감속 보조 구조}{88mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/OBJECT_RISK_TO_FCA_REQUEST_SIGNAL_FLOW_2026-03-28.png}

\FigureImage{ADAS 시퀀스 플로우}{84mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/OBJECT_RISK_TO_WARNING_SIGNAL_FLOW_2026-03-28.png}
...
\FigureImage{비상 보호와 진단 상태 전달 구조}{84mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/FAILSAFE_TO_DIAGNOSTIC_STATE_SIGNAL_FLOW_2026-03-28.png}

\FigureImage{CGW 시퀀스 플로우}{84mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/FAILSAFE_ESCALATION_TO_OUTPUT_SIGNAL_FLOW_2026-03-28.png}
...
\FigureImage{진단 콘솔 및 Trace 관측 화면}{74mm}{../../planning_and_Blog/final_screenshot/image copy 64.png}

\FigureImage{진단 및 관측 그룹 시퀀스 플로우}{84mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/NAV_ALERT_CONTEXT_TO_DCM_REQUEST_RESPONSE_OBSERVATION_SIGNAL_FLOW_2026-03-29.png}
...
\FigureImage{출력 패널과 상태 확인 화면}{74mm}{generated/panel_state_overview.png}

\FigureImage{패널 시퀀스 플로우}{84mm}{../../../canoe/docs/architecture/master_book/png/flows/signal/ROUTE_WARNING_TO_HMI_SIGNAL_FLOW_2026-03-28.png}
...
\FigureImage{기본 주행 시나리오}{72mm}{../../planning_and_Blog/final_screenshot/image copy 61.png}
...
\FigureImage{긴급 접근 시나리오}{72mm}{../../planning_and_Blog/final_screenshot/image copy 63.png}
...
\FigureImage{객체 위험 및 통합 시나리오}{76mm}{../../planning_and_Blog/final_screenshot/image copy 82.png}
...
\FigureImage{비상 보호 및 복귀 시나리오}{76mm}{../../planning_and_Blog/final_screenshot/image copy 77.png}
...
\FigureImage{UT 자산 및 실행 화면}{94mm}{../../planning_and_Blog/final_screenshot/image copy 21.png}

\FigureImage{IT 자산 및 실행 화면}{94mm}{../../planning_and_Blog/final_screenshot/image copy 81.png}

\FigureImage{ST 자산 및 실행 화면}{94mm}{../../planning_and_Blog/final_screenshot/image copy 78.png}
...
\FigureImage{테스트 리포트 대표 판정 화면}{126mm}{generated/test_report_evidence_summary.png}
...
\hline
\textbf{지표} & \textbf{집계 기준} & \textbf{데이터 출처} & \textbf{대표 시험} & \textbf{값} \\ \hline
N1 & V2X 긴급 이벤트 선택 정확도 & XML export / verdict & IT\_006, ST\_016, ST\_017 & 95.7\% \\ \hline
N2 & 교차로·합류구간 통합 경고 성공률 & XML export / scenario verdict & IT\_018, ST\_022, ST\_023 & 90.8\% \\ \hline
N3 & 복귀 안정성 준수율 & XML export / recovery verdict & IT\_009, ST\_035, ST\_036, ST\_045, ST\_046 & 93.9\% \\ \hline
\end{tabularx}
\caption{정량 지표 집계표}
\end{table}
...
\FigureImage{DBC 메시지 및 시그널 구성 화면}{78mm}{../../planning_and_Blog/final_screenshot/image copy 60.png}
