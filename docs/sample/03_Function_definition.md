...
| ECU 동작 | BCM ECU | LIN Slave(WindowMotorECU, ID 0x21)로부터 Motor_Current 수신 → 50A 초과 감지 → DTC B1234 생성 → BCM_FaultStatus(0x500) CAN-LS 전송 | CAPL LIN 수신 핸들러(on linFrame) + DTC 생성 + CAN 전송 로직. | In_Test_01, In_Test_02, In_Test_13, Scene.3~5 |
