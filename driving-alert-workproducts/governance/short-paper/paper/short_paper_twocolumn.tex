...
\begin{figure*}[t]
\centering
\placeholderfigure{52mm}{좌측의 시험 입력 및 시나리오, 중앙의 CANoe SIL CAPL 논리 ECU군과 Validation Harness, 우측의 상태 변수·로그·단위시험/통합시험/시스템시험 결과 판정으로 이어지는 구현 및 시험 구성도를 배치한다.}
