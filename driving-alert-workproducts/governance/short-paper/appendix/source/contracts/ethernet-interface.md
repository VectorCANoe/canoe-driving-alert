...
- `ethVehicleStateMsg`
  - owner: `VCU`
  - consumer: `CGW`, `IBOX`
  - intent: vehicle speed 및 drive-state context
- `ethSteeringMsg`
  - owner: `MDPS`
  - consumer: `CGW`
  - intent: steering activity context
- `ethNavContextMsg`
  - owner: `IVI`
  - consumer: `CGW`, `IBOX`
  - intent: road zone, direction, speed-limit context
- `ETH_EmergencyAlert`
  - owner: `V2X`
  - consumer: emergency-context runtime path
  - intent: emergency ingress context
- `ethObjectRiskInputMsg`
  - owner: `TEST_SCN`
  - consumer: `ADAS`
  - intent: validation-only object-risk stimulus
...
- `ethSelectedAlertMsg`
  - owner: `ADAS`
  - consumer: `BCM`, `IVI`, downstream warning consumer
  - intent: boundary-shaped alert state를 relay하는 selected-alert result
- `ethEmergencyRiskMsg`
  - owner: `ADAS`
  - consumer: ADAS-side consumer, `TEST_SCN`
  - intent: emergency proximity risk
- `ethDecelAssistReqMsg`
  - owner: `ADAS`
  - consumer: `ESC`, `TEST_SCN`
  - intent: deceleration assist request
- `ethObjectRiskStateMsg`
  - owner: `ADAS`
  - consumer: ADAS-side consumer, `TEST_SCN`
  - intent: object risk classification
- `ethObjectScenarioAlertMsg`
  - owner: `ADAS`
  - consumer: `BCM`, `IVI`, `TEST_SCN`
  - intent: object-context warning result
...
- `ethFailSafeStateMsg`
  - owner: `CGW`
  - consumer: `ADAS`, `TEST_SCN`, selected safety observer
  - intent: path health 및 fail-safe mode
- `ETH_EmergencyMonitor`
  - owner: `V2X`
  - consumer: `TEST_SCN`, trace observer
  - intent: emergency transport monitor
- `ethObjectSafetyStateMsg`
  - owner: `CGW`
  - consumer: `ADAS`, `TEST_SCN`, selected observer
  - intent: object-path health 및 event code
