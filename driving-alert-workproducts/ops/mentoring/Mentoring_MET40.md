> TEMP NOTE (STALE)
> 이 문서는 참고용 임시 메모입니다. 공식 SoT는 `driving-alert-workproducts/governance/00e_ECU_Naming_Standard.md`, `driving-alert-workproducts/governance/00f_CAN_ID_Allocation_Standard.md` 및 정식 체인 문서(`01/03/0301/0302/0303/0304/04/05/06/07`)입니다.
...
|---|---|---|---|---|
| M40-01 | 중간보고 제출물 정합 | 중간보고 제출본을 `PPT + 엑셀 + DBC`로 버전/날짜 고정 | [x] | `driving-alert-workproducts/ops/handoff/TMP_MID_AUDIT_MAIN.md`, `driving-alert-workproducts/ops/reports/M40_EVIDENCE_INDEX.md` |
| M40-15 | 중간보고 엑셀 포맷 정합 | 엑셀 첫 탭에 프로젝트 개요 추가 + 팀 간 비교 가능한 탭/컬럼 구조 유지 | [x] | `driving-alert-workproducts/ops/handoff/TMP_MID_AUDIT_MAIN.md`, `driving-alert-workproducts/ops/reports/M40_EVIDENCE_INDEX.md` |
| M40-02 | 도메인 DBC 분리/명명 정리 | 도메인 DBC 구조 유지 + `test_can` 제출 해석 문구 고정 | [x] | `canoe/databases/*.dbc`, `driving-alert-workproducts/0303_Communication_Specification.md` |
| M40-03 | Ethernet SoT 분리 | CAN DBC와 ETH 계약 원본을 분리 명시 | [x] | `canoe/docs/operations/10_ETHERNET_BACKBONE_INTERFACE_SPEC.md`, `driving-alert-workproducts/0302_NWflowDef.md`, `driving-alert-workproducts/0303_Communication_Specification.md` |
| M40-04 | test_can 해석 정리 | `test_can`을 공통/검증용으로 정의하고 오해 방지 설명 확보 | [x] | `driving-alert-workproducts/0303_Communication_Specification.md` |
| M40-05 | 네트워크 도식 수정 | Ethernet 버스선 제거 + 스타형 연결 그림 반영 | [x] | `driving-alert-workproducts/02_Concept_design.md`, `driving-alert-workproducts/ops/assets/current/02_networkflow.png`, `driving-alert-workproducts/ops/reports/M40_EVIDENCE_INDEX.md` |
| M40-06 | Panel 우선순위 반영 | `차량 화면(1) / 제어패널(2) / 상태모니터(3)` 기준을 설계/테스트에 반영 | [x] | `driving-alert-workproducts/04_SW_Implementation.md`, `driving-alert-workproducts/07_System_Test.md`, `driving-alert-workproducts/ops/reports/M40_EVIDENCE_INDEX.md` |
| M40-07 | KPI 과분석 배제 | 분석 지표 중심 대신 `설계대로 동작 검증` 중심으로 정리 | [x] | `driving-alert-workproducts/05_Unit_Test.md`, `driving-alert-workproducts/06_Integration_Test.md`, `driving-alert-workproducts/07_System_Test.md` |
| M40-08 | Req 성격 분리 반영 | `Req_041~043`, `Req_112`를 검증환경/품질 성격으로 명시 | [x] | `driving-alert-workproducts/01_Requirements.md`, `driving-alert-workproducts/00c_Req_Classification_and_Safety_Profile.md` |
| M40-09 | 주기/이벤트 명시 | 0302/0303 핵심 Comm에 Period/Event 표기 누락 없음 | [x] | `driving-alert-workproducts/0302_NWflowDef.md`, `driving-alert-workproducts/0303_Communication_Specification.md` |
| M40-10 | 용어 혼동 제거 | 경보 우선순위 판정과 CAN arbitration 용어 분리 | [x] | `driving-alert-workproducts/03_Function_definition.md`, `driving-alert-workproducts/0301_SysFuncAnalysis.md`, `driving-alert-workproducts/04_SW_Implementation.md` |
| M40-11 | 요구사항 통폐합 품질 | 과세분화 구간 통폐합 근거와 개정 이력 유지 | [x] | `driving-alert-workproducts/01_Requirements.md` 개정이력 |
| M40-12 | CAN ID 설계 근거 | ID 배정 룰(도메인/충돌회피/확장성/예약영역) 문서화 | [x] | `driving-alert-workproducts/0303_Communication_Specification.md` |
| M40-13 | Ethernet DBC 경계 명시 | “Ethernet에는 CAN DBC 직접 적용하지 않음” 문구 고정 | [x] | `driving-alert-workproducts/0302_NWflowDef.md`, `driving-alert-workproducts/0303_Communication_Specification.md` |
| M40-14 | DBC ID 충돌/예약영역 대응 | UDS 예약영역/ID 충돌 대응 원칙과 디펜스 문구 준비 | [x] | `driving-alert-workproducts/0303_Communication_Specification.md`, 본 문서 `4) ID 디펜스 Q&A 메모` |
| M40-16 | 기능 다양화 증설(상태전송 편중 해소) | 신규 기능축을 체인에 추가해 `Req -> Func -> Flow -> Comm -> Var -> Code -> UT/IT/ST` 폐쇄를 확보 | [x] | `driving-alert-workproducts/01_Requirements.md`, `driving-alert-workproducts/03_Function_definition.md`, `driving-alert-workproducts/0301_SysFuncAnalysis.md`, `driving-alert-workproducts/0302_NWflowDef.md`, `driving-alert-workproducts/0303_Communication_Specification.md`, `driving-alert-workproducts/0304_System_Variables.md`, `driving-alert-workproducts/04_SW_Implementation.md`, `driving-alert-workproducts/05_Unit_Test.md`, `driving-alert-workproducts/06_Integration_Test.md`, `driving-alert-workproducts/07_System_Test.md`, `driving-alert-workproducts/ops/reports/Doc_Code_Sync_Report.md` |
| M40-17 | 요구사항 통폐합 리밸런싱 | 신규/기존 Req를 통합 단위 기준으로 재정렬하고 변경 매핑(Old->New)을 유지 | [x] | `driving-alert-workproducts/01_Requirements.md`(C-1~C-4), `driving-alert-workproducts/03_Function_definition.md`(Legacy 전환 매핑), `driving-alert-workproducts/0301_SysFuncAnalysis.md`(Legacy Req 상속), `driving-alert-workproducts/0302_NWflowDef.md`(Legacy Req 상속), `driving-alert-workproducts/0303_Communication_Specification.md`(Legacy Req 상속), `driving-alert-workproducts/0304_System_Variables.md`(Legacy Req 상속), `driving-alert-workproducts/ops/reports/Doc_Code_Sync_Report.md` |
| M40-18 | Pre-Activation 실행 증빙 폐쇄 | `Req_130~Req_155` 활성 전환 항목에 대해 실제 구현/실행 결과(`Pass/Fail`, owner/date, log/capture)를 05/06/07에 채워 G4 재개 기준을 충족 | [~] | `driving-alert-workproducts/04_SW_Implementation.md`, `driving-alert-workproducts/05_Unit_Test.md`, `driving-alert-workproducts/06_Integration_Test.md`, `driving-alert-workproducts/07_System_Test.md`, `canoe/src/*`, `canoe/logging/evidence/ST/*`, `driving-alert-workproducts/ops/reports/M40_EVIDENCE_INDEX.md` |
...
3. 증빙 반영 후 `driving-alert-workproducts/ops/reports/Doc_Code_Sync_Report.md` 재실행으로 체인 정합을 재확인한다.
4. 제출 직전 `ops/handoff/TMP_MID_AUDIT_MAIN.md`의 lock anchor를 최종 제출 커밋으로 1회 재동기화한다.
