...
| 입력 | 시나리오 선택(Validation-only) | 테스트 시나리오 선택 입력 | Validation Harness에서 시험 시나리오를 선택한다. | 선택한 시나리오 실행 확인 |
...
| 출력 | 판정 결과(Validation-only) | 시나리오 판정 결과 출력 | Validation Harness에서 결과를 기록한다. | 시나리오 결과와 로그 기록 일치 확인 |
...
| ECU 동작 | 테스트 실행/판정(Validation-only) | 테스트 시나리오 실행 및 판정 | Validation Harness에서 실행 결과를 기록한다. | 실행 결과와 판정 기록 확인 |
...
| ECU 동작 | 차량 기본 기능 SIL 검증(Validation-only) | 기본 기능 시나리오 실행/판정 | Validation Harness 기반 기본 기능 검증 | 기본 기능 시나리오 판정 확인 |
