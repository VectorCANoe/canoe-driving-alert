...
| 항목 | 기준 | 현재 상태 | 판정 |
|---|---|---|---|
| Req 커버리지(05) | 서비스 핵심 Req_001~Req_043 모두 참조 | 43/43 | OK |
| Req 커버리지(06) | 서비스 핵심 Req_001~Req_043 모두 참조 | 43/43 | OK |
| Req 커버리지(07) | 서비스 핵심 Req_001~Req_043 모두 참조 | 43/43 | OK |
| Req 커버리지(차량 기본 확장) | Req_101~Req_112 체인 반영 | 01/03/0301 반영, 0302~07 확장 진행중 | IN PROGRESS |
