...
- 제출본은 대표 ST만 유지하고, 전수 ST 추적/증빙은 원문 SoT(`driving-situation-alert/07_System_Test.md`)에서 관리한다.

| ST ID | Req/VC(대표) | 시나리오 관점 | 합격 기준(요약) | 상태 |
|---|---|---|---|---|
| ST_SPEED_001 | Req_001~004, Req_006, Req_010 | 속도/제한속도 경고 | `150ms` 내 활성/해제 | Active |
| ST_ZONE_001 | Req_007~009 | 구간 전환 | 구간 정책 즉시 반영 | Active |
| ST_STEER_001 | Req_011, Req_012 | 고속 무조향 | 발생/해제 `150ms` | Active |
| ST_EMS_001 | Req_017, Req_019~022 | 경찰 긴급 접근 | 긴급 우선 경고/표시 | Active |
| ST_EMS_002 | Req_017, Req_019~022 | 구급 긴급 접근 | 긴급 우선 경고/표시 | Active |
| ST_TIMEOUT_001 | Req_023, Req_024, Req_033, Req_034 | 긴급 미수신 복귀 | `1000ms` timeout + `150ms` 복귀 | Active |
| ST_POLICY_001 | Req_025~032, Req_035, Req_040 | 정책/결정론 | 우선순위/표시 정책 일치 | Active |
| ST_SIL_002 | Req_042 | CAN+ETH(대체백본 포함) E2E | 통신/기능 체인 유지 | Active |
| ST_BASE_001 | Req_101~119 | 기본 차량 기능 E2E | 도메인 체인 일관성 | Active |
| ST_V2_RISK_001 | Req_120, Req_121, Req_123, Req_125, Req_126 | 위험도 기반 감속 보조 | 요청/해제/동기화 기준 충족 | Ready |
| ST_V2_FAILSAFE_001 | Req_127~129 | 도메인 단절 fail-safe | 강등/최소경고 유지 | Ready |
| ST_ADAS_OBJ_001 | Req_130~139 | 객체 기반 위험 경고 | TTC/합류/신뢰도 강등 | Planned |
| ST_BASE_ALERT_EXT_001 | Req_140~147 | 경보 편의 확장 | 설정/표시/이력 일관성 | Planned |
| ST_BASE_ROBUST_EXT_001 | Req_148~155 | 강건성·인지성 확장 | 유효성/가용성/동기 복원 | Planned |
