...
- CANoe.CAN 환경에서는 Ethernet 일부 경로(E100/E200 모니터링 및 V2 확장)를 `eth_backbone_can_stub.dbc`(0x064/0x11F/0x232/0x313/0x314/0x315)로 대체 운반한다.
...
|---|---|---|---|---|---|---|---|
| frmVehicleStateCanMsg | 0x100 | 2 | vehicleSpeed | 0~7 | 차량 속도 | 0~255 km/h | VAL_SCENARIO_CTRL -> CHASSIS_GW 전달 |
|  |  |  | driveState | 8~9 | 주행 상태(PRND) | 0~3 | VAL_SCENARIO_CTRL -> CHASSIS_GW 전달 |
| frmSteeringCanMsg | 0x101 | 1 | steeringInput | 0 | 조향 입력 여부 | 0~1 | VAL_SCENARIO_CTRL -> CHASSIS_GW 전달 |
| frmPedalInputCanMsg | 0x102 | 2 | AccelPedal | 0~7 | 가속 페달 입력 | 0~100 % | VAL_SCENARIO_CTRL -> ACCEL_CTRL 전달 |
|  |  |  | BrakePedal | 8~15 | 브레이크 페달 입력 | 0~100 % | VAL_SCENARIO_CTRL -> BRAKE_CTRL 전달 |
...
| frmChassisHealthMsg | 0x109 | 2 | ChassisAliveCnt | 0~7 | Chassis Alive Counter | 0~255 | CHASSIS_GW -> VAL_SCENARIO_CTRL 전달 |
|  |  |  | ChassisDiagState | 8~11 | Chassis 진단 상태 | 0~15 | CHASSIS_GW -> VAL_SCENARIO_CTRL 전달 |
|  |  |  | ChassisFailCode | 12~15 | Chassis 오류 코드 | 0~15 | CHASSIS_GW -> VAL_SCENARIO_CTRL 전달 |
...
| frmIgnitionEngineMsg | 0x300 | 1 | IgnitionState | 0 | 시동 입력 상태 | 0~1 | VAL_SCENARIO_CTRL -> ENGINE_CTRL 전달 |
|  |  |  | EngineState | 1~2 | 엔진 동작 상태 | 0~3 | VAL_SCENARIO_CTRL -> ENGINE_CTRL 전달 |
| frmGearStateMsg | 0x301 | 1 | GearInput | 0~2 | 기어 입력값 | 0~7 | VAL_SCENARIO_CTRL -> TRANSMISSION_CTRL 전달 |
|  |  |  | GearState | 3~5 | 기어 상태값 | 0~7 | VAL_SCENARIO_CTRL -> TRANSMISSION_CTRL 전달 |
...
| frmPowertrainHealthMsg | 0x30A | 2 | PtAliveCnt | 0~7 | Powertrain Alive Counter | 0~255 | DOMAIN_GW_ROUTER -> VAL_SCENARIO_CTRL 전달 |
|  |  |  | PtDiagState | 8~11 | Powertrain 진단 상태 | 0~15 | DOMAIN_GW_ROUTER -> VAL_SCENARIO_CTRL 전달 |
|  |  |  | PtFailCode | 12~15 | Powertrain 오류 코드 | 0~15 | DOMAIN_GW_ROUTER -> VAL_SCENARIO_CTRL 전달 |
...
| frmChassisDiagReqMsg | 0x11D | 3 | ChassisDiagReqId | 0~7 | Chassis 진단 요청 ID | 0~255 | VAL_SCENARIO_CTRL -> CHASSIS_GW 전달 |
|  |  |  | ChassisDiagReqAct | 8 | Chassis 진단 요청 활성 | 0~1 | VAL_SCENARIO_CTRL -> CHASSIS_GW 전달 |
| frmChassisDiagResMsg | 0x11E | 3 | ChassisDiagResId | 0~7 | Chassis 진단 응답 ID | 0~255 | CHASSIS_GW -> VAL_SCENARIO_CTRL 전달 |
|  |  |  | ChassisDiagStatus | 8~11 | Chassis 진단 결과 | 0~15 | CHASSIS_GW -> VAL_SCENARIO_CTRL 전달 |
...
| frmPtDiagReqMsg | 0x30E | 3 | PtDiagReqId | 0~7 | Powertrain 진단 요청 ID | 0~255 | VAL_SCENARIO_CTRL -> DOMAIN_GW_ROUTER 전달 (Validation-only) |
|  |  |  | PtDiagReqAct | 8 | Powertrain 진단 요청 활성 | 0~1 | VAL_SCENARIO_CTRL -> DOMAIN_GW_ROUTER 전달 |
| frmPtDiagResMsg | 0x30F | 3 | PtDiagResId | 0~7 | Powertrain 진단 응답 ID | 0~255 | DOMAIN_GW_ROUTER -> VAL_SCENARIO_CTRL 전달 |
|  |  |  | PtDiagStatus | 8~11 | Powertrain 진단 결과 | 0~15 | DOMAIN_GW_ROUTER -> VAL_SCENARIO_CTRL 전달 |
...
| 구분 | 범위 | 원본 파일 | 비고 |
|---|---|---|---|
| Core CAN Profile | Comm_001, Comm_002, Comm_003, Comm_007, Comm_008, Comm_009 | `canoe/databases/chassis_can.dbc` + `canoe/databases/infotainment_can.dbc` + `canoe/databases/body_can.dbc` + `canoe/databases/eth_backbone_can_stub.dbc` | 경고 코어 체인 단일 원본(CAN-stub 포함) |
| Domain CAN Profile | Comm_101~Comm_106, Comm_201~Comm_205 | `canoe/databases/chassis_can.dbc` + `canoe/databases/powertrain_can.dbc` + `canoe/databases/body_can.dbc` + `canoe/databases/infotainment_can.dbc` + `canoe/databases/eth_backbone_can_stub.dbc` | 차량 기본 기능/도메인 분리 원본(CAN-stub 포함) |
| ETH Stub Transport Profile | Comm_004, Comm_005, Comm_006, Comm_120, Comm_121, Comm_124, Comm_201(일부) | `canoe/databases/eth_backbone_can_stub.dbc` | CANoe.CAN 환경 대체 운반 원본 |
...
|---|---|---|---|---|---|---|---|---|---|
| Comm_001 | Flow_001 | Func_001, Func_002, Func_003, Func_004, Func_006, Func_010 | Req_001, Req_002, Req_003, Req_004, Req_006, Req_010 | frmVehicleStateCanMsg(0x100), ethVehicleStateMsg(0x510) | VAL_SCENARIO_CTRL, CHASSIS_GW | CHASSIS_GW, ADAS_WARN_CTRL | CAN + Ethernet(UDP) | 100ms | 속도/주행상태 입력 갱신 |
| Comm_002 | Flow_002 | Func_011, Func_012 | Req_011, Req_012 | frmSteeringCanMsg(0x101), ethSteeringMsg(0x511) | VAL_SCENARIO_CTRL, CHASSIS_GW | CHASSIS_GW, ADAS_WARN_CTRL | CAN + Ethernet(UDP) | 100ms | 조향 입력 갱신 |
| Comm_003 | Flow_003 | Func_007, Func_010 | Req_007, Req_010 | frmNavContextCanMsg(0x110), ethNavContextMsg(0x512) | VAL_SCENARIO_CTRL, INFOTAINMENT_GW | INFOTAINMENT_GW, NAV_CONTEXT_MGR, ADAS_WARN_CTRL, WARN_ARB_MGR | CAN + Ethernet(UDP) | 100ms | 구간/방향/거리/제한속도 입력 갱신 |
...
| Comm_121 | Flow_121 | Func_121 | Req_121 | ethDecelAssistReqMsg(0x314) | WARN_ARB_MGR | CHASSIS_GW, BRAKE_CTRL, VAL_SCENARIO_CTRL | Ethernet(UDP) + CAN | Event + 50ms | 감속 보조 요청 프레임 |
| Comm_122 | Flow_122 | Func_122 | Req_122 | ethSelectedAlertMsg(0xE200), frmAmbientControlMsg(0x210), frmClusterWarningMsg(0x220) | WARN_ARB_MGR | BODY_GW, IVI_GW, BCM_AMBIENT_CTRL, CLU_HMI_CTRL | Ethernet(UDP) + CAN | 50ms | 감속 보조 활성 경고 동기화 |
| Comm_123 | Flow_123 | Func_123 | Req_123 | frmPedalInputCanMsg(0x102), frmSteeringCanMsg(0x101), ethDecelAssistReqMsg(0x314) | CHASSIS_GW, WARN_ARB_MGR | WARN_ARB_MGR, DOMAIN_GW_ROUTER, BRAKE_CTRL | CAN + Ethernet(UDP) | Event + 100ms | 운전자 개입 시 보조 해제 |
| Comm_124 | Flow_124 | Func_124 | Req_124 | frmChassisHealthMsg(0x109), frmBodyHealthMsg(0x219), frmInfotainmentHealthMsg(0x228), ethFailSafeStateMsg(0x315) | CHASSIS_GW, BODY_GW, INFOTAINMENT_GW, DOMAIN_BOUNDARY_MGR | DOMAIN_BOUNDARY_MGR, DOMAIN_GW_ROUTER, WARN_ARB_MGR, BODY_GW, IVI_GW, VAL_SCENARIO_CTRL | CAN + Ethernet(UDP) | 100ms + Event | 경로 단절 강등/보조 금지 |
...
| ETH Backbone CAN Stub | `canoe/databases/eth_backbone_can_stub.dbc` | Comm_004, Comm_005, Comm_006, Comm_120, Comm_121, Comm_124, Comm_201(일부) | frmEmergencyBroadcastMsg, frmEmergencyMonitorMsg, frmAdasChassisStatusMsg, ethEmergencyRiskMsg, ethDecelAssistReqMsg, ethFailSafeStateMsg |
...
| ETH Backbone CAN Stub | 6 | 0x064, 0x11F, 0x232, 0x313, 0x314, 0x315 | 6~10 |
