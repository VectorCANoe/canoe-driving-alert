...
|---|---|---|---|---|---|---|---|
| ST_SPEED_001 | Req_001,Req_002,Req_003,Req_004,Req_006,Req_010 | VC_001,VC_002,VC_003,VC_004,VC_006,VC_010 | Func_001,Func_002,Func_003,Func_004,Func_006,Func_010 | Flow_001/Comm_001 | Var_012,Var_013,Var_016 | IT_FLOW_001 | 입력 변동 후 `150ms` 이내 경고 활성/해제 상태가 요구와 일치 |
...
| ST_SIL_002 | Req_042 | VC_042 | Func_042 | Flow_001~Flow_009 / Comm_001~Comm_009 | Var_001~Var_026 | IT_SIL_001 | CAN+Ethernet 동시 조건에서 통신/기능 체인 유지 |
