...
- V2 확장 요구(`Req_120~Req_124`)는 `Func_120~Func_124` 구현 활성 상태로 관리한다.
...
| 버전 | 날짜 | 변경 사항 |
|---|---|---|
| 3.19 | 2026-03-03 | V2 구현 정합 반영: `Func_121/Func_123` 소유를 `WARN_ARB_MGR`로 통일하고 상단/하단/시나리오 체인에서 `DECEL_ASSIST_CTRL` 분리 표기를 제거. |
