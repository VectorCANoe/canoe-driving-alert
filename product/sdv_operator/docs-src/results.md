...
- 원본 계약 파일 열기
  ...
  - `artifact open --target native-testcase-blueprints`
...
- `ETA priority`는 functional 결과 용어입니다.
- `CAN bus arbitration`은 network/gateway 결과 용어입니다.
- 진단 라우팅은 현재 `draft_pre_gate`로 읽습니다.
