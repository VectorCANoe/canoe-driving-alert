...
- runtime module 이름이 아니라 `BCM / IVI / CLU / ADAS / V2X / ...` 기준으로 표시
...
4. Batch Snapshot의 Surface 요약에서 `BCM / IVI / CLU / ADAS / V2X` 우선순위를 확인
...
- 원본 계약 파일 열기
  ...
  - `artifact open --target closeout-standard`
  - `artifact open --target evidence-policy`
...
- regression-only reference; official closeout seed는 아님
