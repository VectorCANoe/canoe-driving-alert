...
from cliops.runtime_ops import (
    ...
    cmd_canoe_test_config_list,
    cmd_canoe_test_config_run,
    cmd_canoe_test_config_status,
    cmd_capl_sysvar_get,
    cmd_capl_sysvar_set,
    cmd_doctor,
    cmd_scenario_run,
...
CONTRACT_CANONICAL = [
    ...
    "python scripts/run.py verify batch --run-id <YYYYMMDD_HHMM> --owner <OWNER> --phase <pre|post|full> --execute-native-tier ST --report-formats json,md,junit",
    "python scripts/run.py verify smoke --owner <OWNER>",
    "python scripts/run.py verify collect --run-id <YYYYMMDD_HHMM> --tier ST",
    "python scripts/run.py verify post-run --run-id <YYYYMMDD_HHMM> --tier ST --owner <OWNER>",
...
PARSER_HANDLERS = {
    ...
    "cmd_canoe_test_config_list": cmd_canoe_test_config_list,
    "cmd_canoe_test_config_status": cmd_canoe_test_config_status,
    "cmd_canoe_test_config_run": cmd_canoe_test_config_run,
    ...
    "cmd_verify_post_run": cmd_verify_post_run,
