...
PRODUCT_COMMAND_GROUPS: dict[str, list[PaletteCommand]] = {
    ...
    "Packaging": [
        ...
        PaletteCommand(
            ...
            summary="native testcase intent/oracle/timing blueprint JSON을 바로 엽니다.",
            use_when=(
                "native CANoe testcase 설계 기준을 확인해야 할 때",
                "functional/network/diag pack의 기대값 기준을 한 파일에서 확인하고 싶을 때",
            ),
            ...
            next_step="필요하면 역할 경계 문서와 함께 검토하십시오.",
        ),
        PaletteCommand(
        ...
        PaletteCommand(
            ...
            use_when=(
                "어떤 pack이 mandatory이고 어떤 pack이 draft인지 기준 파일로 확인할 때",
            ),
