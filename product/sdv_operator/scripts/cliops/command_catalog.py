...
PRODUCT_COMMAND_GROUPS: dict[str, list[PaletteCommand]] = {
    ...
    "Runtime Support": [
        ...
        PaletteCommand(
            ...
            notes="결과와 archive 구조를 runtime module이 아니라 surface ECU 기준으로 정리할 때 사용합니다.",
            use_when=(
    ...
    "Packaging": [
        ...
        PaletteCommand(
            ...
            summary="산출물 생성에 쓰이는 Source Contract와 설정 문서를 확인합니다.",
        ...
        PaletteCommand(
            ...
            use_when=(
                "BCM/IVI/CLUSTER/ADAS/V2X 기준 증빙 폴더를 archive 기준으로 바로 보고 싶을 때",
            ),
