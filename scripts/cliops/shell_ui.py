...
def print_shell_help() -> None:
    ...
    print('  /artifact open --target <batch-report|surface-bundle|readiness|doctor|surface-inventory|native-test-portfolio|network-gateway-pack|verification-pack-matrix|traceability-profile|artifact-layout|phase-policy|manifest|commands-doc|results-doc|packaging-doc|archive-run|reports-dir|surface-dir|native-reports|execution-manifest>')
